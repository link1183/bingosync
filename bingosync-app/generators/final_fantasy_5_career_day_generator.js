...
bingoList[2] = [
  ...
  {
    name: "Defeat T-Rex with Phoenix Down/Life/Life 2",
    types: ["boss-special"],
  },
...
bingoList[3] = [
  {
    name: "Get any 3 key items (Exc. Anti-barrier, Bracelet, Adamantite)",
    types: ["key-items"],
  },
...
bingoList[7] = [
  ...
  {
    name: "Get 3 Wind Jobs (KNT | MON | THF | BLM | WHM | BLU)",
    types: ["jobs-crystal"],
  },
  {
    name: "Defeat Minotauros by throwing the Assassin Dagger",
    types: ["boss-special"],
  },
...
bingoList[8] = [
  {
    name: "Get 3 Water Jobs (RED | TIM | SUM | BRS | MYS)",
    types: ["jobs-crystal"],
  },
...
bingoList[9] = [
  {
    name: "Get 3 Fire Jobs (BST | GEO | NIN | HUN | BRD)",
    types: ["jobs-crystal"],
  },
  {
    name: "Speak to the dwarf that hints Mirage Village in the great trench",
    types: ["hint"],
  },
...
bingoList[12] = [
  ...
  {
    name: "Defeat all Water bosses (Triplets | Levi | Gogo)",
    types: ["boss-ex"],
  },
...
bingoList[14] = [
  {
    name: "Get any 5 key items (Exc. Anti-barrier, Bracelet, Adamantite)",
    types: ["key-items"],
  },
...
bingoList[15] = [
  ...
  {
    name: "Defeat all Burning bosses (Iron Claw | Guardian)",
    types: ["boss-ex"],
  },
...
bingoList[16] = [
  ...
  {
    name: "Defeat all Desert bosses (Sandworm | Merugene)",
    types: ["boss-ex"],
  },
...
bingoList[17] = [
  {
    name: "Get any 8 key items (Exc. Anti-barrier, Bracelet, Adamantite)",
    types: ["key-items"],
  },
  {
    name: "Defeat 3 Meteor bosses (Timi | Chimera | Puroboros | Titan)",
    types: ["boss-ex"],
  },
...
bingoList[18] = [
  ...
  {
    name: "Defeat 2 Aerial bosses (Cray Claw | Sol Cannon | Archaevoaevis)",
    types: ["boss-ex"],
  },
...
bingoList[20] = [
  {
    name: "Get any 11 key items (Exc. Anti-barrier, Bracelet, Adamantite)",
    types: ["key-items"],
  },
  {
    name: "Defeat 3 Castle bosses (Shiva | Abductor | Gilga-1 | Carbuncle | Gilga-4)",
    types: ["boss-ex"],
  },
...
bingoList[22] = [
  ...
  {
    name: "Defeat 2 Tower bosses (Galura | Atomos | Minotauros | Omniscient)",
    types: ["boss-ex"],
  },
...
bingoList[23] = [
  ...
  {
    name: "Defeat 2 Mountain bosses (Magisa | Hiryuu Plant | Bahamut)",
    types: ["boss-ex"],
  },
...
bingoList[24] = [
  ...
  {
    name: "Defeat 3 Void bosses (Calo | Apoc | Apanda | Cata | Hali | Twin Tania | Necro)",
    types: ["boss-ex"],
  },
...
bingoList[25] = [
  ...
  {
    name: "Defeat 2 Ship bosses (Karlabos | Siren | Liquid Flame | Gilga-3)",
    types: ["boss-ex"],
  },
