...
var bingoList = [
  ...
  [
    // 2
    {
      name: "Catch a Pokémon that is taller than the player",
      types: ["catch"],
    },
    {
      name: "Catch an Alpha Pokémon using a heavy-type ball",
      types: ["catch"],
    },
    { name: "Five backstrikes in a row", types: ["catch"] },
    {
      name: "Defeat the tutorial Starly five times before catching it",
      types: ["catch"],
    },
  ],
  [
    ...
    {
      name: "Sell 50k worth of items in one shopping trip",
      types: ["overworld"],
    },
  ],
  [
    ...
    {
      name: "Use four different Agile Style moves in one fight",
      types: ["fight"],
    },
    {
      name: "Use four different Strong Style moves in one fight",
      types: ["fight"],
    },
  ],
  [
    ...
    {
      name: "Have 5 different Pokémon that have non-Hisuian regional forms",
      types: ["survey"],
    },
  ...
  [
    ...
    {
      name: "Defeat Kleavor without throwing any non-critical balms",
      types: ["overworld"],
    },
    {
      name: "Defeat any Frenzied Lord without using any Pokémon",
      types: ["overworld"],
    },
    {
      name: "Do not dodge during any Frenzied Lord encounter",
      types: ["overworld"],
    },
  ],
  [
    ...
    {
      name: "Paralyze an opponent and have it lose three turns in a row",
      types: ["fight"],
    },
  ],
  [
    // 8
    {
      name: "Release your starter before fighting Rei/Akari",
      types: ["overworld"],
    },
  ...
  [
    ...
    {
      name: "Send out Hisuian Typhlosion and surround it in smoke",
      types: ["dex"],
    },
  ],
  [
    ...
    {
      name: "Score 125,000+ points in the shooting gallery",
      types: ["overworld"],
    },
  ],
  [
  ...
  [
    ...
    {
      name: "Get paralyzed, drowzy, and poisoned outside of battle",
      types: ["overworld"],
    },
    {
      name: "Submit a report with at least 5 Pokémon where no two start with the same letter",
      types: ["survey"],
    },
    {
      name: "Submit a report with at least 30 Pokémon that are all the same species",
      types: ["survey"],
    },
  ],
  [
  ...
  [
    // 15
    {
      name: "Catch a Pokémon in a Space-Time Distortion",
      types: ["overworld"],
    },
    { name: "Release 90+ Pokémon at the same time", types: ["overworld"] },
    { name: "Raise a GV to level 10", types: ["overworld"] },
    {
      name: "Use 5 Rare Candies on a Pokémon at the same time",
      types: ["overworld"],
    },
  ...
  [
    ...
    {
      name: "Do not catch any Pokémon from trees or rocks",
      types: ["overworld"],
    },
  ...
  [
    ...
    {
      name: "Catch Abra, Kadabra, and Alakazam in the same report",
      types: ["catch"],
    },
  ],
  [
    ...
    {
      name: "Catch a Pokémon without touching the right joystick",
      types: ["catch"],
    },
  ],
  [
    // 19
    {
      name: "Tutor every move available to a Pokémon to it",
      types: ["overworld"],
    },
  ...
  [
    ...
    {
      name: "Catch a fully-evolved Pokémon that is in the air",
      types: ["catch"],
    },
  ...
  [
    // 22
    {
      name: "Traverse from one camp to another without being seen",
      types: ["overworld"],
    },
  ...
  [
    // 24
    {
      name: "Defeat an Alpha using a party of 6 different Eeveelutions",
      types: ["party"],
    },
    {
      name: "Defeat an Alpha using a party of every Burmy and Wormadam form",
      types: ["party"],
    },
    {
      name: "Defeat an Alpha using a party of only Starlies",
      types: ["party"],
    },
    {
      name: "Defeat an Alpha using a party of only baby Pokémon",
      types: ["party"],
    },
    {
      name: "Defeat an Alpha using a party of Scyther, Scizor, and Kleavor",
      types: ["party"],
    },
  ],
  [
    ...
    {
      name: "Reach survey rank 3 before crossing the Obsidian Fieldlands bridge",
      types: ["hard"],
    },
  ],
];
