...
bingoList[6] = [
  ...
  {
    name: "Toxic Pipe Pagie, No Sonar Sheild/Reptile Rush",
    types: ["pagie", "hub", "challenge"],
  },
];
bingoList[7] = [
...
bingoList[8] = [
  ...
  {
    name: "2 Pagies from Unique Transformation",
    types: ["pagie", "transformation"],
  },
  {
    name: "Windtunnel Pagie, No Reptile Rush",
    types: ["pagie", "hub", "challenge"],
  },
  {
    name: "Freezing Room - Intended Way",
    types: ["pagie", "glitter", "challenge"],
  },
];
bingoList[9] = [
...
bingoList[11] = [
  ...
  {
    name: "30 Tokens from broken slot machines",
    types: ["pagie", "cashino", "transformation"],
  },
  {
    name: "Purchase Lizard Leap First",
    types: ["trowzer", "glitter", "challenge"],
  },
];
bingoList[12] = [
...
bingoList[17] = [
  ...
  {
    name: "3 Pagies from Unique Transformation",
    types: ["pagie", "transformation"],
  },
  {
    name: "Brrreeze Intended Way",
    types: ["boss", "glitter", "challenge", "subarea"],
  },
];
bingoList[18] = [
...
bingoList[24] = [
  ...
  {
    name: "4 Pagies from Unique Transformation",
    types: ["pagie", "transformation"],
  },
