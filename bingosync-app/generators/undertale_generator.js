...
bingoList[1] = [
  ...
  {
    name: "Finish with at least 300 G",
    types: ["Waterfall", "Hotlands", "CORE", "Gold"],
  },
];
bingoList[2] = [
  {
    name: "Get Aaron's Yellow Credit",
    types: ["Spare", "Waterfall", "Yellow_Credits"],
  },
...
bingoList[4] = [
  ...
  {
    name: "Rip the Punch Card in battle",
    types: ["Waterfall", "Hotlands", "CORE"],
  },
...
bingoList[5] = [
  ...
  {
    name: "Buy the Nice Cream in Waterfall and Snowdin",
    types: ["Item", "Waterfall", "Snowdin"],
  },
...
bingoList[6] = [
  ...
  {
    name: "Sans says you're going to have a bad time",
    types: ["Kill", "Snowdin"],
  },
...
bingoList[8] = [
  ...
  {
    name: "Extend Lesser Doggo Fully",
    types: ["Dogs", "Snowdin", "Yellow_Credits"],
  },
  { name: "Ride the Ferry in Waterfall", types: ["Waterfall"] },
  { name: "Defuse a Bomb", types: ["Hotlands"] },
  {
    name: "Get Gyftrot's Yellow Credit",
    types: ["Spare", "Snowdin", "Yellow_Credits"],
  },
];
bingoList[9] = [
  {
    name: "Get Yellow Credits for 4 Monsters in Ruins",
    types: ["Spare", "Ruins", "Yellow_Credits"],
  },
...
bingoList[10] = [
  {
    name: "Get Yellow Credits for 10 Monsters overall",
    types: ["Spare", "Yellow_Credits"],
  },
...
bingoList[14] = [
  ...
  {
    name: "Make Temmie say You Will Regret This",
    types: ["Item", "Waterfall"],
  },
];
bingoList[15] = [
  ...
  {
    name: "Get Ballet Shoes, skip Burnt Pan",
    types: ["Item", "Waterfall", "Hotlands"],
  },
];
bingoList[16] = [
  ...
  {
    name: "Spare Royal Guards",
    types: ["Spare", "Hotlands", "Yellow_Credits"],
  },
  { name: "Fall in the Pit 10 times", types: ["Ruins"] },
];
bingoList[17] = [
  {
    name: "Get 10,000 Points in the Mettaton Fight",
    types: ["Kill", "Spare", "CORE"],
  },
  { name: "Get to 7 LV", types: ["Kill"] },
  { name: "Get to 9 LV", types: ["Kill"] },
  {
    name: "Buy the Cloudy Glasses, skip the Old Tutu",
    types: ["Item", "Waterfall"],
  },
...
bingoList[20] = [
  ...
  {
    name: "Spot Flowey following you after Ruins",
    types: ["Snowdin", "Waterfall", "Hotlands", "CORE"],
  },
  { name: "Buy the Junk Food", types: ["Item", "CORE"] },
  {
    name: "Eat the Instant Noodles in Battle",
    types: ["Item", "Hotlands", "CORE"],
  },
];
bingoList[21] = [
...
bingoList[23] = [
  ...
  {
    name: "Exchange 3 Punch Cards for a Nice Cream",
    types: ["Item", "Waterfall"],
  },
