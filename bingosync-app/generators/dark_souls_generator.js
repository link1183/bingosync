...
bingoList[2] = [
  ...
  {
    name: "Take Old Witch's Ring as gift",
    types: ["startingitem", "restrict_key"],
  },
...
bingoList[7] = [
  ...
  { name: "Obtain Remedy", types: ["items", "spells"] },
  {
    ...
    types: ["blighttown", "items", "humanity"],
  },
...
bingoList[8] = [
  {
    ...
    types: ["drakeslondo", "items", "humanity"],
  },
  {
    name: "Obtain Astora's Straight Sword",
    types: ["weapons", "drakeslondo", "items"],
  },
...
bingoList[9] = [
  ...
  { name: "Obtain Great Scythe", types: ["catacombs"] },
  {
    ...
    types: ["items", "spells", "catacombs"],
  },
  {
    name: "Kill Black Knight (The Catacombs)",
    types: ["items", "spells", "catacombs"],
  },
  {
    name: "Kill Titanite Demon (The Catacombs)",
    types: ["enemies", "catacombs"],
  },
...
bingoList[11] = [
  ...
  { name: "Kill Ceaseless Discharge", types: ["demonruins", "bosses"] },
  {
    ...
    types: ["demonruins", "npcs", "covenant"],
  },
  { name: "Join Chaos Covenant", types: ["demonruins", "npcs", "covenant"] },
  {
    name: "Get the Egg Head Infection",
    types: ["demonruins", "enemies", "armour"],
  },
];
// Sen's Fortress
bingoList[12] = [
  {
    name: "Obtain a Spear upgraded with Lightning",
    types: ["items", "weapons"],
  },
  {
    name: "Obtain Covetous Gold Serpent Ring",
    types: ["items", "rings", "sens"],
  },
  {
...
bingoList[16] = [
  ...
  { name: "Never use Miracles", types: ["restriction", "restrict_spell"] },
  {
    ...
    types: ["restriction", "restrict_consumable"],
  },
  {
...
bingoList[24] = [
  ...
  { name: "36 Endurance", types: ["stats", "condition"] },
  {
    ...
    types: ["stats", "restriction", "condition"],
  },
  {
