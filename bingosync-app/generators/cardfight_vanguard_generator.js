...
bingoList[2] = [
  {
    name: "Place a Sentinel only on GC and not using its effects",
    types: ["sentinel", "guard"],
  },
...
bingoList[3] = [
  ...
  {
    name: "Have cards in Exclusion Zone",
    types: ["exclusion", "g-assist", "ultimatestride"],
  },
];
bingoList[4] = [
...
bingoList[7] = [
  {
    name: "Take 2 Damage in one turn (Rescue excluded)",
    types: ["takedamage"],
  },
...
bingoList[8] = [
  {
    name: "Place 5 cards from hand/G-Zone to GC to guard 1 attack",
    types: ["guard"],
  },
  {
    name: "Damage Check 4 Triggers (Rescue excluded)",
    types: ["damagecheck", "trigger"],
  },
...
bingoList[12] = [
  ...
  {
    name: "Win a game on an Ultimate Stride turn",
    types: ["win", "ultimatestride"],
  },
...
bingoList[14] = [
  ...
  {
    name: "Take 3 Damage or more before riding Grade 3",
    types: ["takedamage"],
  },
...
bingoList[15] = [
  ...
  {
    name: "Damage Check 7 Triggers (Rescue excluded)",
    types: ["damagecheck", "trigger"],
  },
...
bingoList[20] = [
  ...
  {
    name: "Take 3 Damage in one turn (Rescue excluded)",
    types: ["elecgate", "ppgate"],
  },
...
bingoList[21] = [
  ...
  {
    name: "Lose the G-Zone after an Ultimate Stride",
    types: ["ultimatestride"],
  },
...
bingoList[24] = [
  ...
  {
    name: "Take 0 damage during two of your opponent’s turn in a row",
    types: ["nodamage"],
  },
