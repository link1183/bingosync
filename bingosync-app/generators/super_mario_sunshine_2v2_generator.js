...
bingoList[2] = [
  { name: "50 Yellow Coins from 3 Levels" },
  { name: "Pianta 100 Coin Shine" },
  { name: "150 Delfino Yellow Coins" },
  { name: "Box Game 3 Shine" },
  { name: "Defeat All 5 Polluted Piranha Plants" },
];
bingoList[3] = [
  { name: "25 Lives" },
  { name: "27 Lives" },
...
bingoList[7] = [
  { name: "Complete 2 Boss Rematches" },
  { name: "6 Ricco Shines" },
...
bingoList[10] = [
  { name: "5 Boss Shines" },
  { name: "8 M Graffiti Entrance Shines" },
...
bingoList[11] = [
  ...
  { name: "4 Enemy Blue Coins (NO Ricco)" },
...
bingoList[18] = [
  ...
  { name: "15 Yellow Coins in Noki 3 Bottle" },
  { name: "All 3 Cannon Mole Shines" },
];
bingoList[19] = [
  { name: "7 Red Coin Shines" },
  { name: "King Boo Shine" },
  { name: "Wear Sunglasses" },
...
bingoList[21] = [
  ...
  { name: "9 Shines from Delfino (With Blue Trades)" },
...
bingoList[22] = [
  ...
  { name: "14 Level Shines" },
  { name: "9 Shines from 1 Level" },
];
bingoList[23] = [
  { name: "8 NPC Blue Coins" },
