...
bingoList[4] = [
  ...
  {
    name: "Recover all normandy dog tags and Shepard's helmet",
    types: ["shop"],
  },
];
bingoList[5] = [
...
bingoList[10] = [
  ...
  {
    name: "Complete monkey shooting mini-game on Tuchanka",
    types: ["tuchanka"],
  },
...
bingoList[13] = [
  ...
  {
    name: "Complete a Loyalty without guns (no Samara/Thane)",
    types: ["loyal"],
  },
  {
    name: "Complete a Loyalty without powers (no Samara/Thane)",
    types: ["loyal"],
  },
...
bingoList[14] = [
  ...
  {
    name: "Complete a Loyalty on Insanity (no Samara/Thane)",
    types: ["loyal"],
  },
];
bingoList[15] = [
...
bingoList[16] = [
  ...
  {
    name: "Complete 10 (non-N7) assignments",
    types: ["Acitadel", "Aomega", "Aillium", "Anor"],
  },
...
bingoList[17] = [
  ...
  {
    name: "Acquire Reaper IFF and activate Legion",
    types: ["recruit", "Legion"],
  },
];
bingoList[18] = [
  ...
  {
    name: "Complete 2 Loyalties on Veteran (no Samara/Thane)",
    types: ["loyal"],
  },
];
bingoList[19] = [
  {
    name: "Kill the Reaper Core without using HW",
    types: ["recruit", "Legion"],
  },
  { name: "Tali Loyalty", types: ["loyal", "tali"] },
  {
    name: "Acquire 6 (non-ship) upgrades of a single type",
    types: [
      "td",
      "sg",
      "ar",
...
bingoList[20] = [
  ...
  {
    name: "In the Arrival DLC, complete Object Rho fight without dying on Veteran difficulty",
    types: ["dlc"],
  },
...
bingoList[22] = [
  ...
  {
    name: "Resolve legion-tali loyalty conflict",
    types: ["loyal", "tali", "legion"],
  },
  {
    name: "Resolve miranda-jack loyalty conflict",
    types: ["loyal", "miranda", "jack"],
  },
];
bingoList[23] = [
