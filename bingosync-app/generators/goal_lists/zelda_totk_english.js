var bingoList = [];
((bingoList[1] = [
  { name: "Defeat an enemy using only Shields", types: ["Combat"] },
  ...
  (bingoList[2] = [
    { name: "Defeat an enemy using only Recall", types: ["Combat"] },
  ...
  (bingoList[3] = [
    { name: "Defeat a Wizzrobe of any kind", types: ["Combat"] },
  ...
  (bingoList[4] = [
    {
      name: "The Hunt for Bubbul Gems! Side Adventure",
    ...
    { name: "Gerudo Canyon Tower", types: ["Tower", "GerudoCanyon", "Gerudo"] },
    ...
    { name: "Use a Royal Guard’s weapon at low durability", types: ["Combat"] },
  ...
  (bingoList[5] = [
    { name: "Confuse 3 enemies with one Muddle Bud", types: ["Combat"] },
    ...
    { name: "A Letter to Koyin SA", types: ["SideAdventures", "MountLanayru"] },
    { name: "Follow the Cuccos SQ", types: ["SideQuests", "SahasraSlope"] },
    { name: "Decorate with Passion SQ", types: ["SideQuests", "GerudoCanyon"] },
    ...
    { name: "Attempt to dye undyable armor", types: ["Armor", "MountLanayru"] },
  ]),
  (bingoList[6] = [
    { name: "Defeat an Armored Enemy", types: ["Combat"] },
    ...
    { name: "4 Lookout Landing Shrines", types: ["LookoutLanding", "Shrines"] },
  ...
  (bingoList[7] = [
    { name: "Defeat a Gibdo using Dazzle Fruit", types: ["Combat"] },
  ...
  (bingoList[8] = [
    { name: "5 Bubbul Gems", types: ["Caves", "Koltin"] },
    ...
    { name: "4 Popla Foothills Shrines", types: ["PoplaFoothills", "Shrines"] },
    {
  ...
  (bingoList[9] = [
    { name: "Find an Old Map and its Treasure", types: ["Sky", "Depths"] },
    {
  ...
  (bingoList[10] = [
    { name: "Defeat 4 Minibosses", types: ["Combat"] },
  ...
  (bingoList[11] = [
    { name: "Defeat a Flux Construct III", types: ["Combat"] },
  ...
  (bingoList[12] = [
    { name: "Upgrade A Horse", types: ["Stables"] },
    ...
    { name: "Bring Peace to Hebra! SA", types: ["Combat", "PikidaStonegrove"] },
  ...
  (bingoList[13] = [
    { name: "Defeat a Stalnox", types: ["Combat", "Night"] },
    {
  ...
  (bingoList[14] = [
    { name: "Defeat a Molduga", types: ["Combat", "Gerudo", "Molduga"] },
  ...
  (bingoList[15] = [
    {
      name: "Serenade to Cotera SA (Dueling Peaks)",
  ...
  (bingoList[16] = [
    {
      name: "Serenade to Mija SA (Hebra)",
    ...
    { name: "Hebra's Colossal Fossil SQ", types: ["SideQuests", "RosproPass"] },
    {
  ...
  (bingoList[17] = [
    {
      name: "Defeat a Frost and Igneo Talus",
  ...
  (bingoList[18] = [
    { name: "Defeat an Armored Lynel", types: ["Combat"] },
    {
  ...
  (bingoList[19] = [
    { name: "Defeat a Thunder Gleeok", types: ["Combat", "Gleeok"] },
  ...
  (bingoList[20] = [
    { name: "10 Autobuild Schematics", types: ["Depths", "Travel"] },
  ...
  (bingoList[21] = [
    { name: "9 Energy Wells", types: ["Depths"] },
  ...
  (bingoList[22] = [
    { name: "Obtain 8 Sage's Wills", types: ["Sky", "Travel"] },
    {
  ...
  (bingoList[23] = [
    { name: "Obtain a Sage's Vow ", types: ["Temples", "Combat"] },
  ...
  (bingoList[24] = [
    {
      name: "Defeat Wind Temple Boss by only Skydiving",
  ...
  (bingoList[25] = [
    { name: "Obtain a Solemn Vow", types: ["Temples", "Sky"] },
