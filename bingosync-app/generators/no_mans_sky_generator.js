...
bingoList[2] = [
  ...
  {
    name: "Visit 5 planets and scan at least one creature there",
    types: ["scanning"],
  },
...
bingoList[3] = [
  ...
  {
    name: "Install a C-Class Multitool Upgrade",
    types: ["upgrades", "multitool"],
  },
...
bingoList[6] = [
  ...
  {
    name: "Extend your freighter base by at least 5 base parts",
    types: ["freighter", "base"],
  },
  {
    name: "Install a C-Class freighter Upgrade",
    types: ["upgrades", "freighter"],
  },
...
bingoList[7] = [
  ...
  {
    name: "Install Survey Device in any Multitool",
    types: ["upgrades", "multitool"],
  },
...
bingoList[9] = [
  ...
  {
    name: "Get one Freighter room blueprint",
    types: ["freighters", "base", "upgrades"],
  },
  {
    name: "Install a B-Class Multitool Upgrade",
    types: ["upgrades", "multitool"],
  },
...
bingoList[12] = [
  ...
  {
    name: "Install a B-Class freighter Upgrade",
    types: ["upgrades", "freighter"],
  },
...
bingoList[13] = [
  ...
  {
    name: "Upgrade Multitool Inventory 2 times",
    types: ["upgrades", "multitool"],
  },
...
bingoList[15] = [
  ...
  {
    name: "Discover a crashed ship or freighter under water",
    types: ["landmarks"],
  },
  {
    name: "Install a A-Class Multitool Upgrade",
    types: ["upgrades", "multitool"],
  },
...
bingoList[16] = [
  ...
  {
    name: "Fully explore (all rooms and goals) a derelict freighter",
    types: ["freighters"],
  },
  { name: "Install a A-Class ship Upgrade", types: ["upgrades", "ship"] },
  { name: "Kill 10 swarm abominations", types: ["combat"] },
  {
    name: "Complete 5 Space station missions for any faction",
    types: ["missions"],
  },
];
bingoList[17] = [
...
bingoList[18] = [
  ...
  {
    name: "Kill 10 creatures on board a derelict freighter",
    types: ["combat"],
  },
];
bingoList[19] = [
  ...
  {
    name: "Install a A-Class freighter Upgrade",
    types: ["upgrades", "freighter"],
  },
...
bingoList[20] = [
  ...
  {
    name: "Get Rank 10 with any faction (alien or guilds)",
    types: ["missions"],
  },
];
bingoList[21] = [
  { name: "Discover 15 landmarks", types: ["landmarks"] },
  {
    name: "Install a S-Class Multitool Upgrade",
    types: ["upgrades", "multitool"],
  },
...
bingoList[25] = [
  {
    name: "Fly to center of the galaxy (Without Anomaly Warp)",
    types: ["exploration"],
  },
  {
    name: "Install a S-Class freighter Upgrade",
    types: ["upgrades", "freighter"],
  },
