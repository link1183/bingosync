...
bingoList[2] = [
  ...
  {
    name: "2 Moons from sub-areas (Lake)",
    types: ["Late_Game", "Lake", "Sub_Areas"],
  },
...
bingoList[9] = [
  ...
  {
    name: "20 Regional Coins (Wooded)",
    types: ["Late_Game", "Wooded_Regional"],
  },
...
bingoList[14] = [
  ...
  {
    name: "Capture both the Cactus and the Tree",
    types: ["Late_Game", "Capture_Both"],
  },
...
bingoList[16] = [
  ...
  {
    name: "2 Moons from sub-areas (Wooded)",
    types: ["Late_Game", "Wooded", "Sub_Areas"],
  },
  { name: "4 Moons (Cap)", types: ["Cap_Moons"] },
  {
    name: "25 Regional Coins (Wooded)",
    types: ["Late_Game", "Wooded_Regional"],
  },
...
bingoList[21] = [
  ...
  {
    name: "4 Moons from sub-areas (Wooded)",
    types: ["Late_Game", "Wooded", "Sub_Areas"],
  },
  { name: "4 Moons from sub-areas (Cap)", types: ["Cap", "Sub_Areas"] },
  {
    name: "35 Regional Coins (Wooded)",
    types: ["Late_Game", "Wooded_Regional"],
  },
];
bingoList[22] = [
...
bingoList[23] = [
  ...
  {
    name: "Capture 2 Fire Bros. (Wooded)",
    types: ["Late_Game", "Capture_Both"],
  },
];
bingoList[24] = [
  ...
  {
    name: "Flower Thieves of Sky Garden (Wooded)",
    types: ["Late_Game", "Wooded_Story", "Story"],
  },
