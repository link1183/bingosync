...
bingoList[7] = [
  {
    name: "120 combined bones in Regent's Park & Toy Factory",
    types: ["rp", "tf"],
  },
  {
    name: "120 combined bones in Toy Store & Spooky Forest",
    types: ["ts", "sf"],
  },
  {
    name: "120 combined bones in Piccadilly & De Vil's Manor",
    types: ["p", "dvm"],
  },
  { name: "120 combined bones in BigBen & Countryside", types: ["bb", "cs"] },
  {
    name: "120 combined bones in Royal Museum & Barnyard",
    types: ["rm", "by"],
  },
  {
    name: "120 combined bones in The Underground & Ancient Castle",
    types: ["u", "ac"],
  },
  { name: "120 combined bones in Carnival & Hedge Maze", types: ["c", "hm"] },
  {
    name: "120 combined bones in Lumber Mill & Ice Festival",
    types: ["lm", "if"],
  },
];
bingoList[8] = [
  {
    name: "50 bones in both Regent's Park & De Vil's Manor",
    types: ["rp", "dvm"],
  },
  ...
  {
    name: "50 bones in both The Underground & Ice Festival",
    types: ["u", "if"],
  },
  { name: "50 bones in both Carnival & Barnyard", types: ["c", "by"] },
  {
    name: "50 bones in both Lumber Mill & Ancient Castle",
    types: ["lm", "ac"],
  },
];
bingoList[9] = [
...
bingoList[13] = [
  ...
  {
    name: "ELP 2 levels after getting 10 combined puppies from them",
    types: ["2lvl"],
  },
];
bingoList[14] = [
  {
    name: "1 puppy from Regent's Park, Barnyard, Toy Store & Ice Festival",
    types: ["rp", "by", "ts", "if"],
  },
  {
    name: "1 puppy from Piccadilly, Ancient Castle & BigBen",
    types: ["p", "ac", "bb"],
  },
  {
    name: "1 puppy from Hedge Maze, Toy Factory & De Vil's Manor",
    types: ["hm", "tf", "dvm"],
  },
  {
    name: "1 puppy from The Underground, Lumber Mill & Carnival",
    types: ["u", "lm", "c"],
  },
  {
    name: "1 puppy from Spooky Forest, Royal Museum & Country Side",
    types: ["sf", "rm", "cs"],
  },
];
bingoList[15] = [
  {
    name: "15 combined puppies from Regent's Park, Toy Store, Piccadilly & BigBen",
    types: ["rp", "ts", "p", "bb"],
  },
  {
    name: "15 combined puppies from Royal Museum, The Underground, Carnival & Lumber Mill",
    types: ["rm", "u", "c", "lm"],
  },
  {
    name: "15 combined puppies from Countryside, Barnyard, Ice Festival & Ancient Castle",
    types: ["cs", "by", "if", "ac"],
  },
  {
    name: "15 combined puppies from Spooky Forest, Hedge Maze, De Vil's Manor and Toy Factory",
    types: ["sf", "hm", "dvm", "tf"],
  },
];
bingoList[16] = [
  {
    name: "Toy Store bubble puppy & Toy Factory on top of Hydraulic Press puppy",
    types: ["ts", "tf"],
  },
  {
    name: "Toy Store pinball puppy & De vil's Manor bed room puppy",
    types: ["ts", "dvm"],
  },
  {
    name: "Toy Store eol area puppy & Hedge Maze eol puppy ",
    types: ["ts", "hm"],
  },
  {
    name: "Toy Store rocket puppy & Spooky Forest underground puppy",
    types: ["ts", "sf"],
  },
  {
    name: "Piccadilly puzzle puppy & Ice Festival eol puppy",
    types: ["p", "if"],
  },
  {
    name: "Piccadilly manhole puppy & Barnyard silo puppy",
    types: ["p", "by"],
  },
  {
    name: "Regent's Park eol puppy & Countryside tree puppy",
    types: ["rp", "cs"],
  },
  {
    name: "BigBen elevator puppy & Carnival blue ticket area puppy",
    types: ["bb", "c"],
  },
];
bingoList[17] = [
  {
    name: "Royal Museum jurassic area puppy & Barnyard toilet puppy",
    types: ["rm", "by"],
  },
  {
    name: "Royal Museum eol area puppy & Hedge Maze room puppy",
    types: ["rm", "hm"],
  },
  {
    name: "Royal Museum inside pyramid puppy & Toy Factory magnetic room puppy",
    types: ["rm", "tf"],
  },
  {
    name: "Royal Museum outside pyramid puppy & Countryside cave puppy",
    types: ["rm", "cs"],
  },
  {
    name: "Royal Museum kitchen puppy & Lumber Mill eol puppy",
    types: ["rm", "lm"],
  },
  {
    name: "Underground eol puppy & Carnival Magic Wagon room 3 puppy",
    types: ["u", "c"],
  },
  {
    name: "Carnival red ticket area puppy & De Vil's Manor paintings puppy",
    types: ["c", "dvm"],
  },
  {
    name: "Ice Festival ice castle puppy & Carnival Magic Wagon room 1 puppy ",
    types: ["if", "c"],
  },
  {
    name: "Ancient Castle behind doors puppy & Carnival green ticket area puppy",
    types: ["ac", "c"],
  },
];
bingoList[18] = [
...
bingoList[23] = [
  ...
  {
    name: "Defeat every human at least once (including Cruella)",
    types: ["h"],
  },
];
bingoList[24] = [
  ...
  {
    name: "Collect 10 things in your inventory",
    types: ["rm", "by", "sf", "lm", "u", "c"],
  },
  { name: "Collect 2 keys", types: ["by", "sf", "lm", "u"] },
  { name: "Collect all tickets in carnival", types: ["c"] },
  {
    name: "Get the golden nut and do a full lap using the train",
    types: ["rp,ts"],
  },
  ...
  {
    name: "Eat a pizza a hamburger, a hot dog, a steak and get the donut",
    types: ["3lvl, rm"],
  },
...
bingoList[25] = [
  {
    name: "Collect 8 stickers in the first page",
    types: ["rp", "ts", "p", "bb"],
  },
  {
    name: "Collect 8 stickers in the second page",
    types: ["rm", "u", "c", "lm"],
  },
  {
    name: "Collect 8 stickers in the third page",
    types: ["cs", "by", "if", "ac"],
  },
  {
    name: "Collect 8 stickers in the fourth page",
    types: ["sf", "hm", "dvm", "tf"],
  },
