...
var bingoList = [];
bingoList[1] = [
  { name: "Buy Tanned Hide", types: ["Armor"] },
...
bingoList[2] = [
  { name: "Find Wrap Boots", types: ["Consumable"] },
...
bingoList[3] = [
  { name: "Find Fruit of Repun", types: ["Consumable"] },
...
bingoList[4] = [
  { name: "Buy Bronze Armor", types: ["Armor"] },
  ...
  {
    name: "Cure a Status Ailment with another Status Ailment",
    types: ["Task"],
  },
...
bingoList[5] = [
  { name: "Find Speed Boots", types: ["Boot"] },
...
bingoList[6] = [
  { name: "Buy Soldier Suit", types: ["Armor"] },
...
bingoList[7] = [
  { name: "Use Bow of Truth", types: ["Bow"] },
  { name: "Find/Buy Battle Shield", types: ["Shield"] },
];
bingoList[8] = [
  { name: "Find Refresh", types: ["Spell"] },
...
bingoList[10] = [
  { name: "Get Stom thrown out of Aryllis’ house", types: ["Spell"] },
];
bingoList[11] = [{ name: "Ride the boat", types: ["Trade Quest"] }];
bingoList[12] = [{ name: "Never buy Shield / Armor", types: ["Combat Task"] }];
bingoList[13] = [
  { name: "Clear the tower with the Sword of Wind", types: ["Combat Task"] },
];
bingoList[14] = [
  { name: "Kill Sabera 2", types: ["Boss"] },
