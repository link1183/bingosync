...
var bingoList = [
  ...
  [
    ...
    {
      name: "Disable a police vehicle in Career Freeroam",
      types: ["pursuit", "takedown"],
    },
  ],
  [
    {
      name: "Escape a police pursuit while in Career Freeroam",
      types: ["escape"],
    },
    {
      name: "Escape a police pursuit in less than 2 minutes while in Career Freeroam",
      types: ["escape"],
    },
    {
      name: "Get busted in a police pursuit while in Career Freeroam",
      types: ["pursuit"],
    },
    {
      name: "Win a Free Roam Challenge in Career Mode",
      types: ["freeroamchallenge"],
    },
  ],
  [
    {
      name: "Disable 5 police vehicles while in Career Freeroam",
      types: ["pursuit", "takedown"],
    },
    {
      name: "Raise the Heat on your car to Level 2 while in Career Freeroam",
      types: ["pursuit", "heat"],
    },
    {
      name: "Disable 10 cops in Career Freeroam",
      types: ["pursuit", "takedown"],
    },
  ...
  [
    ...
    {
      name: "Get a Bounty of 20,000 Cash in a pursuit while in Career Freeroam",
      types: ["pursuit", "bounty"],
    },
    {
      name: "Escape after an 8 minute police pursuit in Career Freeroam",
      types: ["escape"],
    },
    {
      name: "Escape 5 police pursuits while in Career Freeroam",
      types: ["escape"],
    },
  ],
  [
    ...
    {
      name: "Escape after a 12 minute police pursuit while in Career Freeroam",
      types: ["escape"],
    },
  ...
  [
    {
      name: "Commit 6 Infractions in a single pursuit while in Career Freeroam",
      types: ["pursuit"],
    },
    {
      name: "Disable 20 police vehicles while in Career Freeroam",
      types: ["pursuit", "takedown"],
    },
    { name: "Sell 3 cars in Career Mode", types: ["cars"] },
    {
      name: "Cause 50,000 Cost to State in a single pursuit while in Career Freeroam",
      types: ["pursuit", "cts"],
    },
  ],
  [
    ...
    {
      name: "Get a Bounty of 50,000 in pursuit while in Career Freeroam",
      types: ["pursuit", "bounty"],
    },
    {
      name: "Win 5 Free Roam Challenges in Career Mode",
      types: ["freeroamchallenge"],
    },
  ...
  [
    {
      name: "Cause 100,000 Cost to State in a single pursuit while in Career Freeroam",
      types: ["pursuit", "cts"],
    },
    {
      name: "Ram 25 police vehicles while in Career Freroam",
      types: ["pursuit", "ram"],
    },
  ...
  [
    {
      name: "Avoid 10 police roadblocks while in Career Freeroam",
      types: ["pursuit", "roadblocks"],
    },
    { name: "Acquire 5 cars in Career Mode", types: ["cash", "cars"] },
    { name: "Sell 6 cars in Career Mode", types: ["cars"] },
    {
      name: "Ram 50 police vehicles in a single police pursuit while in Career Freeroam",
      types: ["pursuit", "ram"],
    },
  ],
  [
    ...
    {
      name: "Avoid 12 spike strips in a single police pursuit",
      types: ["pursuit", "spikes"],
    },
    {
      name: "Win 10 Free Roam Challenges in Career Mode",
      types: ["freeroamchallenge"],
    },
    {
      name: "Disable 50 police vehicles while in Career Freeroam",
      types: ["pursuit", "takedown"],
    },
  ],
  [
    {
      name: "Avoid 20 police roadblocks while in Career Freeroam",
      types: ["pursuit", "roadblocks"],
    },
    {
      name: "Escape 15 police pursuits while in Career Freeroam",
      types: ["escape"],
    },
    { name: "Have a balance of 100,000 Cash in Career Mode", types: ["cash"] },
    {
      name: "Cause 200,000 Cost to State in a single pursuit while in Career Freeroam",
      types: ["pursuit", "cts"],
    },
  ],
  [
    {
      name: "Immobilise a police Rhino while in Career Freeroam",
      types: ["pursuit"],
    },
    {
      name: "Raise the Heat on your car to Level 4 while in Career Freeroam",
      types: ["pursuit", "heat"],
    },
  ...
  [
    ...
    {
      name: "Avoid a spike strip in a police pursuit while in Career Freeroam",
      types: ["pursuit", "spikes"],
    },
    {
      name: "Conquer all Downtown Palmont tracks in Career Mode",
      types: ["alltracks"],
    },
    {
      name: "Avoid 5 spike strips in a police pursuit while in Career Freeroam",
      types: ["pursuit", "spikes"],
    },
  ],
  [
  ...
  [
    ...
    {
      name: "Avoid 10 police spike strips while in Career Freeroam",
      types: ["pursuit", "spikes"],
    },
    {
      name: "Ram 100 police vehicles in a single pursuit while in Career Freeroam",
      types: ["pursuit", "ram"],
    },
  ...
  [
    {
      name: "Fill your Career Garage with only Muscle Cars",
      types: ["garage"],
    },
    { name: "Fill your Garage with only Exotic Cars", types: ["garage"] },
    {
      name: "Win 25 Free Roam Challenges in Career Mode",
      types: ["freeroamchallenge"],
    },
  ...
  [
    {
      name: "Accumulate a 20,000 fine while in Career Freeroam",
      types: ["pursuit", "fine"],
    },
  ...
  [
    ...
    {
      name: "Raise the Heat on your car to Level 5 while in Career Freeroam",
      types: ["pursuit", "heat"],
    },
  ...
  [
    ...
    {
      name: "Have a balance of 1,000,000 cash in Career Mode",
      types: ["cash"],
    },
    {
      name: "Win 50 Free Roam Challenges in Career Mode",
      types: ["freeroamchallenge"],
    },
  ],
  [
    ...
    {
      name: "Accumulate a fine of 50,000 while in Career Freeroam",
      types: ["pursuit", "fine"],
    },
  ],
];
