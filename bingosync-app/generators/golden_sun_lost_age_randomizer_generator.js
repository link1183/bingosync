...
bingoList[3] = [
  ...
  {
    name: "Enter Air Rock's tablet room",
    types: ["clear", "rocks", "airs_rock"],
  },
  {
    name: "Collect the Air's Rock summon tablet",
    types: ["loc", "summon", "airs_rock"],
  },
...
bingoList[5] = [
  ...
  {
    name: "Collect the item on the Dancing Idol pedestal",
    types: ["loc", "gaia_rock"],
  },
];
...
bingoList[15] = [
  ...
  {
    name: "Reach the top of Shrine of the Sea God",
    types: ["clear", "towers"],
  },
  { name: "Reach the top of Ankohl Ruins", types: ["clear", "towers"] },
  {
    name: "Enter Aqua Rock's tablet room",
    types: ["clear", "rocks", "aqua_rock"],
  },
