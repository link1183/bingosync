...
bingoList[1] = [
  {
    name: "Get a first place prize in 15-tile",
    types: ["minigame", "megalixir"],
  },
  { name: "Use exactly 2 Monks", types: ["party", "monk"] },
  {
    name: "Get a third place prize in the ship 15-tile minigame",
    types: ["minigame"],
  },
  {
    name: "Equip only a Thief's Armlet on the body slot",
    types: ["unique", "nowarrior", "nowhitemage"],
  },
...
bingoList[2] = [
  {
    name: "Get a second place prize in 15-tile",
    types: ["minigame", "elixir", "emergencyexit"],
  },
  ...
  {
    name: "Equip only a Mythril Helmet on the head slot",
    types: ["unique", "nowarrior"],
  },
];
...
bingoList[3] = [
  ...
  {
    name: "Get all of the treasure in the Waterfall Cavern",
    types: ["treasurehunt"],
  },
...
bingoList[4] = [
  ...
  {
    name: "Use exactly one Monk AND one Red Mage",
    types: ["party", "monk", "redmage"],
  },
];
...
bingoList[6] = [
  ...
  {
    name: "Get the Giant's Gloves in the Sunken Shrine",
    types: ["treasurehunt"],
  },
  {
    name: "Complete the Sunken Shrine without escaping combat",
    types: ["norun"],
  },
  {
    name: "Get the Diamond Armor in the Sunken Shrine",
    types: ["treasurehunt"],
  },
  { name: "Do NOT acquire Survival Vests", types: ["default"] },
  {
    name: "Get the Mage's Staff in the Sunken Shrine",
    types: ["treasurehunt"],
  },
  {
    name: "Equip only an Ice Shield on the shield slot",
    types: ["unique", "nowarrior", "nothief", "noclass"],
  },
];
...
bingoList[7] = [
  ...
  {
    name: "Use zero Sleeping Bags, Tents, or Cottages",
    types: ["itemrestriction"],
  },
  {
    name: "Get the Adamantite, but do NOT get the Excalibur",
    types: ["treasurehunt", "excalibur"],
  },
...
bingoList[8] = [
  ...
  {
    name: "Get all of the treasure in present-day Chaos Shrine",
    types: ["treasurehunt"],
  },
  { name: "Use exactly 2 Black Mages", types: ["party", "blackmage"] },
  {
    name: "Get all of the treasure in the Marsh Cave",
    types: ["treasurehunt"],
  },
...
bingoList[9] = [
  {
    name: "Get all of the treasure in Mt. Duergar, including Excalibur",
    types: ["treasurehunt", "duergar"],
  },
  { name: "Use at least 2 Gold Needles", types: ["itemrestriction"] },
  {
    name: "Get all of the treasure in the Western Keep",
    types: ["treasurehunt", "westernkeep"],
  },
...
bingoList[10] = [
  {
    name: "Get all of the treasure in the Citadel of Trials",
    types: ["treasurehunt"],
  },
  {
    name: "Defeat the mighty Blue Dragon at least 10 times",
    types: ["atleast"],
  },
  {
    name: "Learn exactly one status buff spell",
    types: ["monk", "noblackmage", "noredmage", "nowhitemage"],
  },
  {
    name: "Do NOT run from any battle in the Cavern of Earth",
    types: ["norun"],
  },
  {
    name: "Get all of the treasure in the Mermaids' room",
    types: ["treasurehunt"],
  },
  { name: "Get the Dragon Mail in the Mirage Tower", types: ["treasurehunt"] },
  {
    name: "Do NOT run from any battle in the Citadel of Trials",
    types: ["norun"],
  },
];
...
bingoList[11] = [
  {
    name: "Get the Ice Armor in the Cavern of Ice",
    types: ["treasurehunt", "icecave"],
  },
  {
    name: "Cast Thundara against a group of Earth Elementals",
    types: ["situational"],
  },
  {
    name: "Do NOT run from any battle in the Flying Fortress",
    types: ["norun", "mirage"],
  },
  {
    name: "Learn exactly one elemental damage spell",
    types: ["monk", "noredmage", "noblackmage"],
  },
  { name: "Get the Ice Brand in Mt. Gulg", types: ["gulg"] },
  {
    name: "Get the Flame Sword in the Cavern of Ice",
    types: ["treasurehunt", "icecave"],
  },
...
bingoList[12] = [
  {
    name: "Get the Aegis Shield in the Mirage Tower",
    types: ["treasurehunt", "mirage"],
  },
  {
    name: "Get the clothes in the Cavern of Ice",
    types: ["treasurehunt", "icecave"],
  },
  { name: "Get the Rat's Tail, but do NOT class change", types: ["noclass"] },
  {
    name: "Buy exactly 18 Mythril Swords in Crescent Lake",
    types: ["spending"],
  },
  {
    name: "Get the Sunblade in the Mirage Tower",
    types: ["treasurehunt", "sunblade"],
  },
...
bingoList[13] = [
  ...
  {
    name: "Get the White Robe and Black Robe in the Flying Fortress",
    types: ["treasurehunt"],
  },
...
bingoList[14] = [
  ...
  {
    name: "Get the Protect Cloak in the Chaos Shrine",
    types: ["treasurehunt"],
  },
  ...
  {
    name: "Obtain an Emergency Exit from Purple Worm",
    types: ["emergencyexit"],
  },
  { name: "Defeat Red Pirahna", types: ["fight"] },
  { name: "Obtain an Elixir from Death Eye", types: ["elixir"] },
  {
    name: "Get both Healing Helms from treasure chests",
    types: ["treasurehunt"],
  },
];
...
bingoList[15] = [
  ...
  {
    name: "Obtain a Megalixir, but not from 15-tile puzzle",
    types: ["megalixir", "deatheye"],
  },
  { name: "Defeat Ankheg", types: ["fight"] },
  { name: "Defeat Green Dragon", types: ["fight", "greendragon"] },
  {
    name: "Put a Green Dragon to sleep",
    types: ["situational", "greendragon"],
  },
];

bingoList[16] = [
  {
    name: "Defeat Death Eye at least 10 times",
    types: ["atleast", "deatheye"],
  },
  {
    name: "Get all of the treasure in the Dragon Caves",
    types: ["treasurehunt"],
  },
  ...
  {
    name: "Get at least 2 Ribbons from treasure chests",
    types: ["treasurehunt"],
  },
  {
    name: "Use the spell Exit to escape from Mt. Gulg",
    types: ["noclass", "exit"],
  },
...
bingoList[17] = [
  ...
  {
    name: "Get only 1 of Sunblade or Diamond Armor from chests",
    types: ["sunblade", "diamondarmor"],
  },
...
bingoList[18] = [
  ...
  {
    name: "Get at least 3 shields from treasure chests",
    types: ["treasurehunt"],
  },
...
bingoList[20] = [
  {
    name: "Learn at least one Level 7 spell for a character",
    types: ["grind"],
  },
  { name: "Defeat Ahriman", types: ["earthgift", "extra"] },
  { name: "No duplicate gloves equipped", types: ["unique"] },
  {
    name: "Learn at least two Level 6 spells for a character",
    types: ["grind"],
  },
  { name: "Defeat Red Dragon", types: ["rare"] },
  {
    name: "Learn three Level 4 spells for at least two characters",
    types: ["grind"],
  },
];
...
bingoList[21] = [
  {
    name: "Get Sasuke's Blade in the Flying Fortress",
    types: ["treasurehunt"],
  },
  { name: "Use at least 5 different Inns", types: ["inn"] },
  {
    name: "Buy 99 Faerie Tonics at the Caravan",
    types: ["spending", "caravan"],
  },
  {
    name: "Unlock one blue seal in the Labyrinth of Time",
    types: ["labyrinth"],
  },
  { name: "Buy exactly 33 Prorings in Gaia", types: ["spending", "gaia"] },
  {
    name: "Learn three Level 1, 2, and 3 spells for a character",
    types: ["grind"],
  },
];
...
bingoList[22] = [
  {
    name: "Buy 99 Giant's Tonics at the Caravan",
    types: ["spending", "caravan"],
  },
  ...
  {
    name: "Get at least 55,000 gil from treasure chests",
    types: ["treasurehunt"],
  },
  {
    name: "Unlock one red seal in the Labyrinth of Time",
    types: ["labyrinth"],
  },
...
bingoList[23] = [
  ...
  {
    name: "Use the spell Exit to escape from Waterfall Cavern",
    types: ["exit", "noclass"],
  },
  {
    name: "Get at least 10 weapons from treasure chests",
    types: ["treasurehunt"],
  },
  { name: "Use all 7 Inns", types: ["inn"] },
  { name: "Buy exactly 22 Cat Claws in Gaia", types: ["spending", "gaia"] },
  {
    name: "Kill four different enemies in one encounter",
    types: ["situational"],
  },
...
bingoList[24] = [
  ...
  {
    name: "Defeat Two-headed Dragon in Earthgift Shrine",
    types: ["earthgift", "extra"],
  },
  {
    name: "Unlock two blue seals in the Labyrinth of Time",
    types: ["labyrinth"],
  },
];
...
bingoList[25] = [
  ...
  {
    name: "Defeat Cerberus in Earthgift Shrine",
    types: ["earthgift", "extra"],
  },
  { name: "Get at least 1 character to level 37", types: ["grind"] },
  { name: "Learn three Level 5 spells for a character", types: ["grind"] },
  {
    name: "Unlock two red seals in the Labyrinth of Time",
    types: ["labyrinth"],
  },
  {
    name: "Defeat Gilgamesh and Atomos in Lifespring Grotto",
    types: ["whisperwind", "extra"],
  },
];
