...
bingoList[4] = [
  {
    name: "Collect and Keep A Copper, Silver, and Gold Bracelet",
    types: ["shop"],
  },
...
bingoList[17] = [{ name: "Defeat Lich with QAKE", types: ["lich"] }];
bingoList[18] = [
...
bingoList[25] = [
  ...
  {
    name: "Successfully Cure a Status Ailment in Battle with White Magic",
    types: ["spell"],
  },
