...
bingoList[9] = [
  ...
  {
    name: "Stand on top of 6 portals that you own the talisman for",
    types: [],
  },
...
bingoList[12] = [
  {
    name: "Talismans from Colossus, Skelos Badlands & Fracture Hills",
    types: [],
  },
...
bingoList[14] = [
  ...
  {
    name: "Activate all powerups in Glimmer, Idol Springs & Skelos Badlands",
    types: [],
  },
...
bingoList[22] = [
  ...
  {
    name: "Activate all powerups in Colossus, Cloud Temples & Metropolis",
    types: [],
  },
];
bingoList[23] = [
  ...
  {
    name: "100+ gems in Skelos Badlands, 2+ orbs in Aquaria Towers & 300+ gems in Metropolis",
    types: [],
  },
];
bingoList[24] = [
...
bingoList[25] = [
  {
    name: "Stand on top of 10 portals & both skulls in Skelos Badlands",
    types: [],
  },
