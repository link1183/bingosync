...
bingoList[1] = [
  ...
  {
    name: "Bump into the force fields in Stone Hill, Cliff Town & Jacques",
    types: ["misc2"],
  },
...
bingoList[2] = [
  ...
  {
    name: "Use all supercharge ramps in Tree Tops & get ultra-superflame in Haunted Towers",
    types: ["misc2"],
  },
...
bingoList[3] = [
  ...
  {
    name: "Stand on the lighthouse in Twilight Harbor & the shack in Misty Bog",
    types: ["misc1"],
  },
  {
    name: "Do 5 laps of the purple gem area in Cliff Town without dying in between",
    types: ["misc2"],
  },
  { name: "5 dragons in Wizard Peak & Cliff Town", types: ["dragon1"] },
];
bingoList[4] = [
  { name: "100% Gnorc Cove", types: ["max"] },
  { name: "All dragons in Misty Bog", types: ["max"] },
  {
    name: "700 Combined Gems in Alpine Ridge & Haunted Towers",
    types: ["gem"],
  },
  ...
  { name: "5 dragons in Dark Hollow & Wizard Peak", types: ["dragon3"] },
];
bingoList[5] = [
...
bingoList[6] = [
  ...
  {
    name: "Kill 5 gnorcs with the canon & evolve/devolve 5 different enemies'",
    types: ["hw"],
  },
];
bingoList[7] = [
  ...
  {
    name: "Rescue 7 dragons who say 'thank(s) (you) for releasing me",
    types: ["misc3"],
  },
...
bingoList[8] = [
  ...
  {
    name: "1 egg from Peace Keepers Home, Magic Crafters Home & High Caves",
    types: ["egg"],
  },
  { name: "250 gems in each of 3 Peace Keepers levels", types: ["world"] },
  { name: "Rescue Lucas and then complete Sunny Flight", types: ["misc2"] },
  {
    name: "Key chests in Ice Cavern, Beast Makers Home & Gnorc Cove",
    types: ["misc3"],
  },
  {
    name: "600 combined gems in Terrace Village & Dark Passage",
    types: ["gem"],
  },
];
bingoList[9] = [
  ...
  {
    name: "Key chests in Peace Keepers Home, Tree Tops & Jacques",
    types: ["misc3"],
  },
...
bingoList[10] = [
  ...
  {
    name: "Eggs from Town Square, Peace Keepers Home & Alpine Ridge",
    types: ["egg"],
  },
...
bingoList[11] = [
  ...
  {
    name: "4 dragons in Dr Shemp, Beast Makers Home & Twilight Harbor",
    types: ["dragon2"],
  },
...
bingoList[12] = [
  ...
  {
    name: "350 Combined Gems in Stone Hill & Magic Crafters Home",
    types: ["gem"],
  },
  { name: "7 dragons in Town Square & Alpine Ridge", types: ["dragon1"] },
  { name: "15 lives", types: [] },
  {
    name: "Jump over Dr Shemp’s spinning rod 25 times without getting hit in between",
    types: ["misc2"],
  },
...
bingoList[13] = [
  ...
  {
    name: "Collect an egg in Stone Hill, Cliff Town & Wizard Peak",
    types: ["egg"],
  },
  {
    name: "4 dragons in Cliff Town, Blowhard & Gnorc Gnexus",
    types: ["dragon3"],
  },
];
bingoList[14] = [
  ...
  {
    name: "3 dragons in Toasty, Beast Makers Home & Metalhead",
    types: ["dragon3"],
  },
];
bingoList[15] = [
  ...
  {
    name: "400 Combined Gems in Dark Hollow & Twilight Harbor",
    types: ["gem"],
  },
  { name: "Kiss all superflame faeries", types: ["misc3"] },
  { name: "300 gems in each of 2 Gnasty’s World levels", types: ["world"] },
  {
    name: "Light both torches in Dark Hollow & Collect all 6 lamp gems in Ice Cavern",
    types: ["misc2"],
  },
...
bingoList[16] = [
  ...
  {
    name: "3 dragons in Toasty, Blowhard & Terrace Village",
    types: ["dragon2"],
  },
  {
    name: "500 Combined Gems in Ice Cavern & Dream Weavers Home",
    types: ["gem"],
  },
  { name: "10 Magic Crafters dragons", types: ["world"] },
  {
    name: "Get a key in 3 levels and leave through the vortex with it still in the inventory",
    types: ["misc3"],
  },
  {
    name: "Defeat all 9 druids in Alpine Ridge & rescue 15 dragons",
    types: [],
  },
...
bingoList[17] = [
  ...
  { name: "300 gems in both Alpine Ridge & Jacques", types: ["gem"] },
];
bingoList[18] = [
...
bingoList[20] = [
  ...
  {
    name: "4 Dragons in Magic Crafters Home, Metalhead & Gnorc Cove",
    types: ["dragon2"],
  },
  {
    name: "Collect all eggs from Artisans & Peace Keepers levels",
    types: ["egg"],
  },
  { name: "5 Gnasty’s World dragons", types: ["world"] },
  {
    name: "Defeat all thieves in both Tree Tops & Gnasty Gnorc",
    types: ["misc3"],
  },
  {
    name: "Key chests in Stone Hill, Dry Canyon & Metalhead",
    types: ["misc3"],
  },
  { name: "450 combined gems in Dry Canyon & Gnorc Gnexus", types: ["gem"] },
];
bingoList[21] = [
...
bingoList[22] = [
  ...
  {
    name: "All key & strong chests from Gnasty's World levels",
    types: ["misc3"],
  },
  { name: "10 Dream Weavers dragons", types: ["world"] },
  { name: "All gems from Toasty & Gnorc Gnexus", types: ["gem"] },
  {
    name: "4 dragons in Peace Keepers Home & Twilight Harbor",
    types: ["dragon1"],
  },
];
bingoList[23] = [
  ...
  {
    name: "Kill both platform druids in High Caves w/supercharge",
    types: ["misc2"],
  },
  {
    name: "Break the strong chests in Dark Passage & Twilight Harbor",
    types: ["misc1"],
  },
];
bingoList[24] = [
  ...
  {
    name: "400 combined gems in Artisans Home & Terrace Village",
    types: ["gem"],
  },
  ...
  {
    name: "Key chests in Dark Hollow, Magic Crafters Home & Lofty Castle",
    types: ["misc3"],
  },
