...
bingoList[7] = [{ name: "Beat Larry (W1)" }, { name: "Fire Kill a Koopaling" }];
bingoList[8] = [{ name: "Hammer W4 Rock" }, { name: "Cloud into Airship" }];
bingoList[9] = [
  { name: "Defeat Lakitu" },
  { name: "Defeat Boo" },
  { name: "Defeat Thwomp" },
];
bingoList[10] = [{ name: "Complete N Card" }, { name: "Frog Level" }];
bingoList[11] = [{ name: "Beat Morton Jr. (W2)" }, { name: "W2 Hidden Bro" }];
bingoList[12] = [
  { name: "Beat Iggy (W4)" },
