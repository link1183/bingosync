...
bingoList[14] = [
  ...
  {
    name: "1 Star each from Gusty Garden, Freezeflame and Dusty Dune",
    types: ["W4"],
  },
...
bingoList[18] = [
  ...
  {
    name: "6 Stars from 1 Galaxy",
    types: ["Battlerock", "DustyDune", "Trial"],
  },
...
bingoList[20] = [
  ...
  {
    name: "Gusty Garden Comet, Freezeflame Comet and Dusty Dune Comet",
    types: ["Comet", "W4"],
  },
];
bingoList[21] = [
...
bingoList[22] = [
  ...
  { name: "4 Stars from Deep Dark", types: ["DeepDark", "W6"] },
  {
    name: "1 Star each from Deep Dark, Dreadnought and Melty Molten",
    types: ["W6"],
  },
  { name: "8 Unique Boss Stars", types: ["Boss"] },
...
bingoList[23] = [
  ...
  {
    name: "Both Garbage Mini-Game Stars",
    types: ["Battlerock", "Dreadnought", "Secret", "W6"],
  },
  ...
  {
    name: "Gold Leaf Comet, Sea Slide Comet and Toy Time Comet",
    types: ["Comet", "W5"],
  },
  {
    name: "Deep Dark S, Dreadnought S and Melty Molten S",
    types: ["Secret", "W6"],
  },
];
bingoList[24] = [
  ...
  {
    name: "Defeat Dino Piranha and Fiery Dino Piranha",
    types: ["Boss", "MeltyMolten", "W6"],
  },
  { name: "All 3 Undergrunt Gunner Fights", types: ["Boss", "W6"] },
  {
    name: "Defeat Topmaniac in both Battlerock and Dreadnought",
    types: ["Boss", "W6", "Dreadnought"],
  },
