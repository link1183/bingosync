...
bingoList[3] = [
  ...
  {
    name: "Get 2 different items that contain the word “Max”",
    types: ["Items"],
  },
];
bingoList[4] = [
...
bingoList[5] = [
  ...
  {
    name: "Sneak up on a Pokémon in 3 unique environments",
    types: ["Catching"],
  },
...
bingoList[8] = [
  {
    name: "Catch a Pokemon with 1+ Stars of Potential from Dexnav",
    types: ["Static"],
  },
  { name: "Full Party No Duplicate Types", types: ["Catching"] },
  {
    name: "Use an attack with the Metronome at max power",
    types: ["Battling"],
  },
...
bingoList[9] = [
  ...
  {
    name: "Have 5 Different NPCs Heal your Party (No Centers)",
    types: ["Static"],
  },
  {
    name: "Collect all the berries in the Berry Master’s Garden",
    types: ["Items"],
  },
];
bingoList[10] = [
  ...
  {
    name: "Catch a Pokémon that has a unique form (megas don't count)",
    types: ["Catching"],
  },
  ...
  {
    name: "Defeat a Gym Leader with a Pokémon of their type",
    types: ["Battling"],
  },
...
bingoList[11] = [
  ...
  {
    name: "Evolve a Pokemon that Normally Evolves Via Trade",
    types: ["Catching"],
  },
...
bingoList[12] = [
  ...
  {
    name: "Catch 3 different Pokémon that start with a vowel",
    types: ["Catching"],
  },
...
bingoList[15] = [
  ...
  {
    name: "Catch 2 different Pokémon with regional forms",
    types: ["Catching"],
  },
...
bingoList[17] = [{ name: "20 Pokémon Owned", types: ["Catching"] }];
bingoList[18] = [
...
bingoList[24] = [{ name: "Don’t jump off any ledges", types: ["Static"] }];
bingoList[25] = [
