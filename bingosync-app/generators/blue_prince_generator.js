...
var bingoList = [
  ...
  [
    ...
    {
      name: "Dig up something other than a turnip, key, or coin",
      types: ["dig"],
    },
    { name: "Enhance your lockpicking skill at least twice", types: ["lab"] },
    { name: "Eat a delicious apple", types: ["stars", "apple"] },
    {
      name: "Pick a gem flower from somewhere other than the Greenhouse",
      types: ["flower"],
    },
  ],
  [
    ...
    {
      name: "Have 2 or more items before drafting any rooms in the manor",
      types: ["item"],
    },
  ...
  [
    ...
    {
      name: "Obtain a total of 10 permanent and room upgrades",
      types: ["upgrade"],
    },
    { name: "Destroy the Keeper", types: ["bgph"] },
    {
      name: "Obtain the power of a chess piece",
      types: ["precipice", "chess"],
    },
  ],
  [
  ...
  [
    {
      name: "Enter the Antechamber while drafting every red room you see",
      types: ["red"],
    },
    {
      name: "Enter the Antechamber while never having more than 2 items in your inventory",
      types: ["item"],
    },
    {
      name: "Enter the Antechamber while never having fewer than 20 steps",
      types: ["steps", "purple"],
    },
    {
      name: "Enter the Antechamber with no rooms in the West Wing",
      types: ["wing"],
    },
    {
      name: "Enter the Antechamber with no rooms in the East Wing",
      types: ["wing"],
    },
    {
      name: "Enter the Antechamber without drafting a green room",
      types: ["green"],
    },
  ],
  [
    ...
    {
      name: "Draft an Outer Room that really shouldn’t be there (Foundation, Entrance Hall, Antechamber, 46)",
      types: ["monk"],
    },
