...
bingoList[3] = [
  {
    name: "Defeat Batafire",
    types: ["midboss", "rainbow", "moonlight", "cabbage", "mustard"],
  },
  {
    name: "Defeat Box Boxer",
    types: ["midboss", "rainbow", "cabbage", "mustard", "peppermint", "candy"],
  },
  {
    name: "Defeat Boxy",
    types: ["midboss", "moonlight", "mustard", "olive", "radish"],
  },
];
bingoList[4] = [
  {
  ...
  {
    name: "Defeat Mr. Frosty",
    types: ["midboss", "moonlight", "olive", "peppermint"],
  },
...
bingoList[12] = [
  ...
  {
    name: "Defeat Phan Phan",
    types: ["midboss", "mustard", "carrot", "peppermint", "candy"],
  },
  {
    name: "Defeat Master Hand",
    types: ["midboss", "rainbow", "radish", "candy"],
  },
];
bingoList[13] = [
