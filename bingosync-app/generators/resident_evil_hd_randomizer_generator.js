...
bingoList[4] = [
  ...
  {
    name: "Kill Dog Whistle Dogs with Handgun",
    types: ["kill", "dog", "handgun"],
  },
...
bingoList[9] = [
  {
    name: "Save Order: Lisa's Cabin / 1F West Wing Medical Storage / Lab B3",
    types: ["save", "cabin", "lab", "west"],
  },
  { name: "Magnum in Inventory", types: ["magnum", "inventory"] },
  {
    name: "Cover the Tentacle with the Box in Guardhouse",
    types: ["objective", "guardhouse"],
  },
...
bingoList[10] = [
  {
    name: "Guardhouse 001 in Inventory",
    types: ["key", "inventory", "guardhouse"],
  },
  { name: "Get Kenneth's Film", types: ["file"] },
  { name: "Use All Gems", types: ["objective", "gems"] },
  { name: "Make VJOLT", types: ["objective", "guardhouse"] },
  {
    name: "Save Order: East Wing Storeroom / Lisa's Cabin / Courtyard B1",
    types: ["save", "east", "cabin", "courtyard"],
  },
];
bingoList[11] = [
  ...
  {
    name: "All Guardhouse Keys in Item Box",
    types: ["key", "guardhouse", "box"],
  },
  {
    name: "Save Order: Guardhouse / Courtyard B1 / Main Hall",
    types: ["save", "guardhouse", "courtyard", "mansion"],
  },
];
bingoList[12] = [
...
bingoList[15] = [
  ...
  {
    name: "Guardhouse 003 in Inventory",
    types: ["key", "inventory", "guardhouse"],
  },
...
bingoList[16] = [
  ...
  {
    name: "Save in East Wing Storeroom/West Wing Medical Storage/Lab B3",
    types: ["save", "east", "west", "Lab"],
  },
...
bingoList[18] = [
  ...
  {
    name: "Kill Elder Crimson with Knife",
    types: ["kill", "crimson", "knife"],
  },
...
bingoList[23] = [
  {
    name: "Kill both hunters in east wing stairway with Knife",
    types: ["kill", "hunter", "knife"],
  },
...
bingoList[24] = [
  {
    name: "Kill All the Zombies in Murder Hall with Knife",
    types: ["kill", "Zombies", "Knife"],
  },
