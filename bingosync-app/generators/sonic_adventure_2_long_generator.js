...
bingoList[10] = [
  ...
  {
    name: "Destroy the Gold Beetle in 3 Hero Story stages (M5 only)",
    types: ["10"],
  },
...
bingoList[13] = [
  ...
  {
    name: "Destroy the Gold Beetle in 3 Dark Story stages (M5 only)",
    types: ["13"],
  },
...
bingoList[25] = [{ name: "120 Emblems (Team Combined)", types: ["25"] }];
