...
bingoList[13] = [
  {
    name: "Collect all Minikits in Negotiations",
    types: ["negotiations", "amk", "collect"],
  },
  {
    name: "Collect all Minikits in Invasion of Naboo",
    types: ["ion", "amk", "collect"],
  },
  {
    name: "Collect all Minikits in Escape From Naboo",
    types: ["efn", "amk", "collect"],
  },
  {
    name: "Collect all Minikits in Mos Espa Podrace",
    types: ["pr", "amk", "collect"],
  },
  {
    name: "Collect all Minikits in Retake Theed Palace",
    types: ["rtp", "amk", "collect"],
  },
...
bingoList[14] = [
  {
    name: "Collect all Minikits in Discovery on Kamino",
    types: ["dk", "amk", "collect"],
  },
  {
    name: "Collect all Minikits in Droid Factory",
    types: ["df", "amk", "collect"],
  },
  {
    name: "Collect all Minikits in Jedi Battle",
    types: ["jb", "amk", "collect"],
  },
  {
    name: "Collect all Minikits in Gunship Cavalry",
    types: ["gc", "amk", "collect"],
  },
...
bingoList[15] = [
  {
    name: "Collect all Minikits in Battle Over Coruscant",
    types: ["boc", "amk", "collect"],
  },
  {
    name: "Collect all Minikits in General Grievous",
    types: ["gg", "amk", "collect"],
  },
  {
    name: "Collect all Minikits in Defense of Kashyyyk",
    types: ["dok", "amk", "collect"],
  },
  {
    name: "Collect all Minikits in Ruin of the Jedi",
    types: ["rotj", "amk", "collect"],
  },
  { name: "Collect 70 Minikits", types: ["mk", "collect"] },
];
bingoList[16] = [
  {
    name: "Collect all Minikits in Count Dooku",
    types: ["cd", "amk", "collect"],
  },
  {
    name: "Collect all Minikits in Darth Vader",
    types: ["dv", "amk", "collect"],
  },
  {
    name: "Collect all Minikits in Darth Maul",
    types: ["dm", "amk", "collect"],
  },
  { name: "Collect 90 Minikits", types: ["mk", "collect"] },
];
bingoList[17] = [
  {
    name: "Collect at Least 3 Minikits in Negotiations",
    types: ["negotiations", "collect", "3mk"],
  },
  {
    name: "Collect at Least 3 Minikits in Invasion of Naboo",
    types: ["ion", "collect", "3mk"],
  },
  {
    name: "Collect at Least 3 Minikits in Escape from Naboo",
    types: ["efn", "collect", "3mk"],
  },
  {
    name: "Collect at Least 3 Minikits in Podrace",
    types: ["pr", "collect", "3mk"],
  },
  {
    name: "Collect at Least 3 Minikits in Retake Theed Palace",
    types: ["rtp", "collect", "3mk"],
  },
];
bingoList[18] = [
  {
    name: "Collect at Least 3 Minikits in Discovery on Kamino",
    types: ["dk", "collect", "3mk"],
  },
  {
    name: "Collect at Least 3 Minikits in Droid Factory",
    types: ["df", "collect", "3mk"],
  },
  {
    name: "Collect at Least 3 Minikits in Jedi Battle",
    types: ["jb", "collect", "3mk"],
  },
  {
    name: "Collect at Least 3 Minikits in Gunship Cavalry",
    types: ["gc", "collect", "3mk"],
  },
];
bingoList[19] = [
  {
    name: "Collect at Least 3 Minikits in Battle Over Coruscant",
    types: ["boc", "collect", "3mk"],
  },
  {
    name: "Collect at Least 3 Minikits in Chancellor in Peril",
    types: ["cip", "collect", "3mk"],
  },
  {
    name: "Collect at Least 3 Minikits in General Grievous",
    types: ["gg", "collect", "3mk"],
  },
  {
    name: "Collect at Least 3 Minikits in Defense of Kashyyyk",
    types: ["dok", "collect", "3mk"],
  },
  {
    name: "Collect at Least 3 Minikits in Ruin of the Jedi",
    types: ["rotj", "collect", "3mk"],
  },
];
bingoList[20] = [
  {
    name: "Collect at Least 3 Minikits in Darth Maul",
    types: ["dm", "collect", "3mk"],
  },
  {
    name: "Collect at Least 3 Minikits in Count Dooku",
    types: ["cd", "collect", "3mk"],
  },
  {
    name: "Collect at Least 3 Minikits in Darth Vader",
    types: ["dv", "collect", "3mk"],
  },
