...
bingoList[1] = [
  ...
  {
    name: "Hear ♪ Kitty Attack",
    types: ["Vanilla", "Chocolate", "Saya", "Seana"],
  },
...
bingoList[2] = [
  ...
  {
    name: "Defeat Holo-Defense System (Rainbow Maid)",
    types: ["Cicini", "Lab", "Rainbow Maid"],
  },
...
bingoList[3] = [
  ...
  {
    name: "Hear ♪ Midboss Battle",
    types: ["Big Box", "Rainbow Maid", "Robot Maids", "Crystals"],
  },
...
bingoList[5] = [
  ...
  {
    name: "Carrot Bomb, Super Carrot, and Hourglass",
    types: ["Carrot Bomb", "Super Carrot", "Hourglass"],
  },
  ...
  {
    name: "Health Plus and Surge Badges",
    types: ["Health Plus", "Health Surge"],
  },
  {
    name: "Arm Strength and Carrot Boost Badges",
    types: ["Arm Strength", "Carrot Boost"],
  },
  ...
  {
    name: "All 5 Southern Woodland Health Up Potions",
    types: ["Southern Woodland", "Health Up"],
  },
  {
    name: "All 3 Western Coast Attack Up Potions",
    types: ["Western Coast", "Attack Up"],
  },
  { name: "10 Island Core items", types: ["Island Core", "Collection"] },
  {
    name: "All 4 Island Core Health Up Potions",
    types: ["Island Core", "Health Up"],
  },
  {
    name: "All 4 Northern Tundra Warp Stones",
    types: ["Northern Tundra", "Warp Stone"],
  },
  {
    name: "10 Eastern Highlands items",
    types: ["Eastern Highlands", "Collection"],
  },
  {
    name: "All 3 Eastern Highlands Warp Stones",
    types: ["Eastern Highlands", "Warp Stone"],
  },
  { name: "Hear ♪ Aurora Palace", types: ["Northern Tundra"] },
  { name: "Hear ♪ Volcanic Canerns", types: ["Subterranean Area"] },
  {
    name: "Use at least 20 PP",
    types: [
      "Pack Up",
      "Health Plus",
      "Health Surge",
  ...
  {
    name: "Have at least 100 max MP",
    types: ["Mana Up", "MaxMP Buff", "Mana Plus", "Mana Surge", "Health Wager"],
  },
...
bingoList[6] = [
  ...
  {
    name: "Hex Cancel and Lucky Seven Badges",
    types: ["Hex Cancel", "Lucky Seven"],
  },
  ...
  {
    name: "10 Southern Woodland items",
    types: ["Southern Woodland", "Collection"],
  },
  {
    name: "1 Subterranean Area Warp Stone",
    types: ["Subterranean Area", "Warp Stone"],
  },
...
bingoList[7] = [
  ...
  {
    name: "Healing Staff, Soul Heart, Book of Carrot, and Max Bracelet",
    types: ["Green", "Soul Heart", "Book", "Bracelet"],
  },
  ...
  {
    name: "All 3 Southern Woodland Regen Up Potions",
    types: ["Southern Woodland", "Regen Up"],
  },
  { name: "10 Western Coast items", types: ["Western Coast", "Collection"] },
  {
    name: "All 3 Island Core Regen Up Potions",
    types: ["Island Core", "Regen Up"],
  },
  {
    name: "Have an SSS rank or higher shown on the Town menu",
    types: ["Boss"],
  },
  {
    name: "Hear ♪ Bounce Bounce",
    types: ["Nieve", "Nixie", "Keke Bunny", "Seana"],
  },
...
bingoList[8] = [
  ...
  {
    name: "All 3 Southern Woodland Pack Up Potions",
    types: ["Southern Woodland", "Pack Up"],
  },
  { name: "15 Western Coast items", types: ["Western Coast", "Collection"] },
  {
    name: "All 6 Western Coast Mana Up Potions",
    types: ["Western Coast", "Mana Up"],
  },
  { name: "15 Island Core items", types: ["Island Core", "Collection"] },
  {
    name: "All 4 Island Core Attack Up Potions",
    types: ["Island Core", "Attack Up"],
  },
  {
    name: "All 4 Eastern Highlands Health Up Potions",
    types: ["Eastern Highlands", "Health Up"],
  },
];
bingoList[9] = [
  {
    name: "Air Jump",
    types: ["Air Jump", "System Interior", "Cicini", "Syaro"],
  },
  {
    name: "Quick Barrette, Charge Ring, Plus Necklace, and Auto Earrings",
    types: ["Barrette", "Ring", "Necklace", "Earrings"],
  },
  ...
  {
    name: "4 Health, Mana, Regen, Pack, Attack Up",
    types: ["Health Up", "Mana Up", "Regen Up", "Pack Up", "Attack Up"],
  },
  {
    name: "15 Southern Woodland items",
    types: ["Southern Woodland", "Collection"],
  },
  {
    name: "All 6 Southern Woodland Mana Up Potions",
    types: ["Southern Woodland", "Mana Up"],
  },
  {
    name: "10 Northern Tundra items",
    types: ["Northern Tundra", "Collection"],
  },
  { name: "Have a MAX rank shown on the Town menu", types: ["Boss"] },
  { name: "Hear ♪ cyberspace.exe", types: ["System Interior"] },
  {
    name: "Equip at least 6 Badges",
    types: [
      "Pack Up",
      "Health Plus",
      "Health Surge",
...
bingoList[10] = [
  ...
  {
    name: "Recruit Cocoa, Chocolate, and Vanilla",
    types: ["Cocoa", "Chocolate", "Vanilla", "Green Kotri"],
  },
  { name: "Defeat All 3 Otaku Battles", types: ["Ch4"] },
  { name: "20 Western Coast items", types: ["Western Coast", "Collection"] },
  {
    name: "All 5 Western Coast Health Up Potions",
    types: ["Western Coast", "Health Up"],
  },
  {
    name: "All 4 Western Coast Warp Stones",
    types: ["Western Coast", "Warp Stone"],
  },
  {
    name: "All 4 Island Core Mana Up Potions",
    types: ["Island Core", "Mana Up"],
  },
  {
    name: "All 4 Northern Tundra Mana Up Potions",
    types: ["Northern Tundra", "Mana Up"],
  },
  {
    name: "All 2 Northern Tundra Pack Up Potions",
    types: ["Northern Tundra", "Pack Up"],
  },
  { name: "7 Northern Tundra Easter Eggs", types: ["Northern Tundra", "Eggs"] },
  {
    name: "4 Eastern Highlands Easter Eggs",
    types: ["Eastern Highlands", "Eggs"],
  },
];
bingoList[11] = [
  ...
  {
    name: "Purchase the Give DEF Down Buff",
    types: ["Give DEF Down Buff", "Nieve"],
  },
  { name: "Purchase the Shrink Buff", types: ["Shrink Buff", "Ashuri"] },
  {
    name: "Purchase 4 Buffs at Once",
    types: [
      "Attack Up Buff",
      "Defense Up Buff",
      "Arrest Buff",
  ...
  {
    name: "All 3 Western Coast Pack Up Potions",
    types: ["Western Coast", "Pack Up"],
  },
  { name: "5 Western Coast Easter Eggs", types: ["Western Coast", "Eggs"] },
  {
    name: "15 Eastern Highlands items",
    types: ["Eastern Highlands", "Collection"],
  },
  {
    name: "All 4 Eastern Highlands Mana Up Potions",
    types: ["Eastern Highlands", "Mana Up"],
  },
  {
    name: "All 4 Eastern Highlands Pack Up Potions",
    types: ["Eastern Highlands", "Pack Up"],
  },
];
bingoList[12] = [
  ...
  {
    name: "Sunny Beam, Chaos Rod, Healing Staff, Explode Shot, and Rainbow Shot",
    types: ["Yellow", "Purple", "Green", "Red", "Rainbow"],
  },
  ...
  {
    name: "Purchase the Give ATK Down Buff",
    types: ["Give ATK Down Buff", "Nixie"],
  },
  { name: "10 Health Up and 10 Mana Up", types: ["Health Up", "Mana Up"] },
  {
    name: "15 Northern Tundra items",
    types: ["Northern Tundra", "Collection"],
  },
  {
    name: "4 Subterranean Area Easter Eggs",
    types: ["Subterranean Area", "Eggs"],
  },
  { name: "18 Warp Stones", types: ["Warp Stone"] },
  {
    name: "Use at least 30 PP",
    types: [
      "Pack Up",
      "Health Plus",
      "Health Surge",
...
bingoList[13] = [
  ...
  {
    name: "ATK Trade, Crisis Boost, and Arm Strength Badges",
    types: ["ATK Trade", "Crisis Boost", "Arm Strength"],
  },
  { name: "10 Pack Up Potions", types: ["Pack Up"] },
  { name: "12 Easter Eggs", types: ["Eggs"] },
  {
    name: "20 Southern Woodland items",
    types: ["Southern Woodland", "Collection"],
  },
  { name: "20 Island Core items", types: ["Island Core", "Collection"] },
  { name: "7 Island Core Easter Eggs", types: ["Island Core", "Eggs"] },
  {
    name: "All 3 Northern Tundra Regen Up Potions",
    types: ["Northern Tundra", "Regen Up"],
  },
  {
    name: "20 Eastern Highlands items",
    types: ["Eastern Highlands", "Collection"],
  },
  {
    name: "All 3 Eastern Highlands Regen Up Potions",
    types: ["Eastern Highlands", "Regen Up"],
  },
  {
    name: "All 6 Eastern Highlands Attack Up Potions",
    types: ["Eastern Highlands", "Attack Up"],
  },
  { name: "Have 2 MAX ranks shown on the Town menu", types: ["Boss"] },
  {
    name: "Equip at least 7 Badges",
    types: [
      "Pack Up",
      "Health Plus",
      "Health Surge",
...
bingoList[14] = [
  ...
  {
    name: "Fire, Water, Nature, and Light Orbs",
    types: ["Fire Orb", "Water Orb", "Nature Orb", "Light Orb"],
  },
  {
    name: "Health and Mana Wager Badges",
    types: ["Health Wager", "Mana Wager"],
  },
  {
    name: "Recruit 6 Towns Members",
    types: [
      "Ashuri",
      "Pandora",
      "Rita",
  ...
  {
    name: "8 Southern Woodland Easter Eggs",
    types: ["Southern Woodland", "Eggs"],
  },
  { name: "6 System Interior items", types: ["System Interior", "Collection"] },
  {
    name: "Have at least 500 max HP",
    types: [
      "Health Up",
      "MaxHP Buff",
      "Health Plus",
...
bingoList[15] = [
  ...
  {
    name: "5 Health, Mana, Regen, Pack, Attack Up",
    types: ["Health Up", "Mana Up", "Regen Up", "Pack Up", "Attack Up"],
  },
...
bingoList[16] = [
  ...
  {
    name: "Slide Powder, Air Jump, Air Dash, and Wall Jump",
    types: ["Slide", "Air Jump", "Air Dash", "Wall Jump"],
  },
...
bingoList[17] = [
  ...
  {
    name: "Recruit Ashuri, Pandora, and Rita",
    types: ["Ashuri", "Pandora", "Rita"],
  },
  {
    name: "Recruit Nieve, Nixie, and Cocoa",
    types: ["Cocoa", "Nieve", "Nixie", "Green Kotri"],
  },
...
bingoList[19] = [
  ...
  {
    name: "All 5 Northern Tundra Health Up Potions",
    types: ["Northern Tundra", "Health Up"],
  },
];
bingoList[20] = [
...
bingoList[22] = [
  {
    name: "All 5 Northern Tundra Attack Up Potions",
    types: ["Northern Tundra", "Attack Up"],
  },
  { name: "End with 50000 EN", types: ["Money"] },
  { name: "15 Pack Up Potions", types: ["Pack Up"] },
  {
    name: "75% Western Coast Map",
    types: ["Western Coast", "Map", "Halloween"],
  },
];
bingoList[23] = [
  ...
  {
    name: "10 Western Coast Easter Eggs",
    types: ["Western Coast", "Eggs", "Halloween"],
  },
...
bingoList[24] = [
  ...
  {
    name: "6 Health, Mana, Regen, Pack, Attack Up",
    types: ["Health Up", "Mana Up", "Regen Up", "Pack Up", "Attack Up"],
  },
  {
    name: "20 Northern Tundra items",
    types: ["Northern Tundra", "Collection"],
  },
  {
    name: "Equip at least 9 Badges",
    types: [
      "Pack Up",
      "Health Plus",
      "Health Surge",
