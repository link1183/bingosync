...
bingoList[2] = [
  ...
  {
    name: "Prototype Detector (HoB5)",
    types: ["treasure", "ek", "sublevelClear", "boss"],
  },
...
bingoList[6] = [
  ...
  {
    name: "Sunseed Berry (AW) and Combustion Berry (SH2)",
    types: ["multiCave"],
  },
  { name: "Lose 20 Pikmin to fire", types: ["harm"] },
  { name: "Lose 20 Pikmin to explosions", types: ["harm"] },
  {
    name: "Trigger all 3 hazard cutscenes (Poison, Fire, and Water)",
    types: [],
  },
];
bingoList[7] = [
  ...
  {
    name: "Crystal Clover (BK1) and Eternal Emerald Eye (BK6)",
    types: ["multiSublevel"],
  },
];
bingoList[8] = [
  ...
  {
    name: "Defeat a Red, Orange, and Hairy Bulborb, and a Spotty Bulbear",
    types: ["enemy"],
  },
  { name: "The Key (CoS5)", types: ["treasure", "ek", "boss"] },
  {
    name: "Olimarnite Shell (BK3) and Colossal Fossil (BK6)",
    types: ["multiSublevel"],
  },
...
bingoList[9] = [
  ...
  {
    name: "Have a Leaf Pikmin in the ground mature into a Flower Pikmin",
    types: [],
  },
  {
    name: "Superstick Textile (WFG3) and Exhausted Superstick (SCx1)",
    types: ["multiArea"],
  },
...
bingoList[10] = [
  ...
  {
    name: "Crystallized Telekinesis, Telepathy, and Clairvoyance (SH1, 4, and 5)",
    types: ["multiSublevel"],
  },
...
bingoList[11] = [
  ...
  {
    name: "Leviathan Feather (SH1) and Science Project (SH6)",
    types: ["multiSublevel"],
  },
];
bingoList[12] = [
  ...
  {
    name: "Defeat an Emperor and Empress Bulblax",
    types: ["enemy", "boss", "ek"],
  },
  { name: "Clear FC3", types: ["sublevelClear"] },
  {
    name: "Thirst Activator [US] / Perfect Container [PAL] (SCx7)",
    types: ["treasure"],
  },
...
bingoList[14] = [
  ...
  {
    name: "Petrified Heart (WFG2), Tear Stone (BK2), and Regal Diamond (CoS5)",
    types: ["multiArea", "sublevelClear"],
  },
  {
    name: "Essential Furnishing (FC1) and Innocence Lost (FC4)",
    types: ["multiSublevel"],
  },
...
bingoList[15] = [
  ...
  {
    name: "Network Mainbrain, Vacuum Processor, and Indomitable CPU (SCx2, 6, and 7)",
    types: ["multiSublevel"],
  },
...
bingoList[16] = [
  {
    name: "Danger Chime (FC3) and Spouse Alert (FC7)",
    types: ["multiSublevel"],
  },
  { name: "Destroy the poison gate in VoR", types: ["obstacle"] },
  {
    name: "Stellar Orb (SCx9)",
    types: ["ek", "treasure", "boss", "sublevelClear"],
  },
  { name: "Defeat 7 Cannon Beetles (of any kind)", types: ["enemy"] },
  { name: "Enter HoH without destroying the electric gate", types: ["enter"] },
  {
    name: "Fruit Guard [US] / Empty Space Container [PAL] (CoC8)",
    types: ["treasure", "sublevelClear"],
  },
...
bingoList[17] = [
  ...
  {
    name: "King of Sweets (CoS4), Diet Doomer (SmC1), and Pale Passion (SmC4)",
    types: ["multiCave"],
  },
  { name: "300 Total Pikmin", types: ["pikmin"] },
  { name: "Clear SR6", types: ["sublevelClear"] },
  {
    name: "Optical Illustration [US] / Abstract Masterpiece [PAL] (PP)",
    types: ["treasure"],
  },
  {
    name: "Endless Repository [US] / Permanent Container [PAL] (SR5)",
    types: ["treasure"],
  },
];
bingoList[18] = [
  ...
  {
    name: "Nutrient Silo [US] / Stringent Container [PAL] (HoH6)",
    types: ["treasure", "sublevelClear"],
  },
];
bingoList[19] = [
  ...
  {
    name: "Dimensional Slicer [US] / Patience Tester [PAL] (HoH9)",
    types: ["treasure", "sublevelClear"],
  },
];
bingoList[20] = [
  ...
  {
    name: "Adamantine Girdle (SCx5) and Massage Girdle (PP)",
    types: ["multiArea"],
  },
  { name: "Clear CoC3", types: ["sublevelClear"] },
  { name: "Clear SmC4", types: ["sublevelClear"] },
  {
    name: "Professional Noisemaker (SmC5)",
    types: ["treasure", "ek", "sublevelClear", "boss"],
  },
];
bingoList[21] = [
  ...
  {
    name: "Clear 3 sublevels with Antenna Beetles, without defeating them",
    types: ["sublevelClear", "multiArea"],
  },
  { name: "4 toy ring treasures", types: ["multiArea"] },
  {
    name: "Memorial Shell (CoS3) and Scrumptious Shell (SR3)",
    types: ["multiCave"],
  },
...
bingoList[23] = [
  ...
  {
    name: "Defeat an Emperor Bulblax without using Pikmin",
    types: ["enemy", "boss"],
  },
...
bingoList[24] = [
  {
    name: "Durable Energy Cell (SR2), Proton AA (SmC4), and Fuel Reservoir (CoC7)",
    types: ["multiArea"],
  },
  { name: "Clear DD12", types: ["sublevelClear"] },
  {
    name: "Toxic Toadstool (WFG4), Anti-Hiccup Fungus (WW), and Growshroom (CoC6)",
    types: ["multiArea"],
  },
  {
    name: "Omniscient Sphere (FC4), Mirth Sphere (CoC1), and Love Sphere (HoH3)",
    types: ["multiArea", "sublevelClear"],
  },
];
bingoList[25] = [
  {
    name: "Unknown Merit (BK4), Lustrous Element (HoH4), and Mirrored Element (DD4)",
    types: ["multiArea", "sublevelClear"],
  },
  {
    name: "Essence of Rage (FC1), Despair (CoC2), True Love (HoH2), and Desire (DD7)",
    types: ["multiArea", "sublevelClear"],
  },
  {
    name: "Silencer (CoC10)",
  ...
  {
    name: "Remembered Old Buddy (HoH15)",
    types: ["treasure", "ek", "sublevelClear", "boss"],
  },
