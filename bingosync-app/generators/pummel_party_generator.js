...
var bingoList = [
  ...
  [
    {
      name: "Get 5 kills in Altitude Attack",
      types: ["minigame", "alat", "challenge"],
    },
    {
      name: "Eat all players in Sharky Swim",
      types: ["minigame", "shsw", "challenge"],
    },
    {
      name: "Don’t get hit by any cars with 3+ loot in Traffic Theft",
      types: ["minigame", "trth", "challenge"],
    },
  ],
  [
    {
      name: "Always pick a unique bridge in a game of Selfish Stride",
      types: ["minigame", "sest", "challenge"],
    },
  ],
  [
    {
      name: "Get the highest combo bonus in Rocking Rhythm",
      types: ["minigame", "rorh", "challenge"],
    },
    {
      name: "Don’t fall off the course in Rusty Racers",
      types: ["minigame", "rura", "challenge"],
    },
    {
      name: "Don’t fall in the water in Slippery Sprint",
      types: ["minigame", "fps", "slsp", "challenge"],
    },
  ],
  [
    {
      name: "Have the reaper collect Blood for you",
      types: ["board", "random"],
    },
    {
      name: "Have the reaper collect Keys for you",
      types: ["board", "random"],
    },
  ],
  [
    {
      name: "Use the Swap Portal to give an opponent a Goblet",
      types: ["board", "item", "bad"],
    },
    {
      name: "Visit a Goblet chest without opening it",
      types: ["board", "bad"],
    },
  ],
  [
