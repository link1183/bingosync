...
bingoList[10] = [
  ...
  { name: "Saria's Song", types: ["SongSaria"] },
  {
    ...
    types: ["SongSerenade", "SongRBA", "ContentIC"],
  },
...
bingoList[12] = [
  ...
  {
    name: "Golden Rupee Chest in Fire Temple",
    types: ["ContentFire", "SkullFire"],
  },
...
bingoList[14] = [
  ...
  {
    name: "Defeat Joelle (Red Poe) & Beth (Blue Poe)",
    types: ["ContentForest"],
  },
...
bingoList[19] = [
  ...
  {
    name: "Open 4 Small Key Chests in Spirit Temple",
    types: ["ContentSpirit"],
  },
...
bingoList[21] = [
  {
    ...
    types: ["Swords", "Tunics", "Boots", "Shields"],
  },
...
bingoList[22] = [
  ...
  {
    name: "Open All 5 Small Key Chests in Spirit Temple",
    types: ["ContentSpirit"],
  },
  { name: "Light Arrows", types: ["ArrowsLight", "BeatSpirit", "BeatShadow"] },
  {
    name: "Beat 5 Dungeons",
    types: ["BeatDeku", "BeatDC", "BeatForest", "BeatWater", "BeatShadow"],
  },
  {
    name: "Obtain All 3 Spiritual Stones",
    types: ["BeatDeku", "BeatDC", "BeatJabu"],
  },
];
...
bingoList[24] = [
  {
    ...
    types: ["ArrowsFire", "ArrowsIce", "ArrowsLight"],
  },
