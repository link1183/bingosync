...
bingoList[1] = [
  ...
  {
    name: "Destroy all 11 Geyser training dummies",
    types: ["checklist", "hub1"],
  },
...
bingoList[3] = [
  ...
  {
    name: "Break 4 rolling barrels in Misty Island",
    types: ["unique", "hub1"],
  },
  {
    name: "Complete the fish minigame without missing a fish",
    types: ["challenge", "hub1"],
  },
];
bingoList[4] = [
  {
    name: "Get eaten by the shark in 4 different levels",
    types: ["checklist", "multihub"],
  },
  {
    name: "Die from burning, drowning, dark eco, and a rat",
    types: ["checklist", "multihub"],
  },
];
bingoList[5] = [
  {
    name: "Take fall damage in 4 different levels",
    types: ["checklist", "multihub"],
  },
  { name: "Go too fast in Mountain Pass", types: ["challenge", "hub2"] },
  {
    name: "Flut Flut cell in Boggy without Flut Flut or yellow eco",
    types: ["challenge", "hub2"],
  },
  {
    name: "Kill all 3 frogs and 2 groups of bats in Boggy",
    types: ["checklist", "hub2"],
  },
];
bingoList[6] = [
  ...
  {
    name: "All scout flies in Forbidden Jungle",
    types: ["collectables", "hub1"],
  },
];
bingoList[7] = [
  { name: "Finish the ambush in Misty Island", types: ["task", "hub1"] },
  {
    name: "Knock down all 4 bones in Misty Island",
    types: ["checklist", "hub1"],
  },
...
bingoList[8] = [
  ...
  {
    name: "Yellow switch cell in Snowy without a skip",
    types: ["challenge", "hub3"],
  },
...
bingoList[12] = [
  {
    name: "Break 9 different scout flies with yellow eco",
    types: ["checklist", "multihub"],
  },
  {
    name: "Kill 5 lurkers with the ice lurker in Snowy",
    types: ["challenge", "hub3"],
  },
];
bingoList[13] = [
  {
    name: "Break 3 orb crates in Sentinel without the cannon",
    types: ["challenge", "hub1"],
  },
...
bingoList[14] = [
  {
    name: "Reach at least 25 total scout flies",
    types: ["collectables", "multihub"],
  },
...
bingoList[15] = [
  ...
  {
    name: "Kill all 7 giant spiders in Spider Cave",
    types: ["checklist", "hub3"],
  },
  {
    name: "Get a cell while powered with blue, red, and yellow eco each",
    types: ["checklist", "multihub"],
  },
];
bingoList[16] = [
...
bingoList[17] = [
  {
    name: "Hidden Mountain Pass cell without a skip",
    types: ["unique", "hub2"],
  },
  { name: "All orbs in robot room (116)", types: ["collectables", "hub3"] },
  {
    name: "Defeat Klaww without losing any health",
    types: ["challenge", "hub2"],
  },
];
bingoList[18] = [
  ...
  {
    name: "Kill all 9 lurkers in Fire Canyon without dying",
    types: ["challenge", "hub1"],
  },
];
bingoList[19] = [
...
bingoList[20] = [
  ...
  {
    name: "Reach at least 400 total orbs",
    types: ["collectables", "multihub"],
  },
];
bingoList[21] = [
...
bingoList[23] = [{ name: "All cells in LPC", types: ["collectables", "hub2"] }];
bingoList[24] = [
  {
    name: "All Snowy Mountain cells without Flut Flut",
    types: ["challenge", "hub3"],
  },
  {
    name: "Reach at least 35 total cells",
    types: ["collectables", "multihub"],
  },
  {
    name: "Finish Mountain Pass and Lava Tube in reverse",
    types: ["challenge", "multihub"],
  },
];
bingoList[25] = [
  { name: "Finish Mountain Pass orbless", types: ["challenge", "hub2"] },
  {
    name: "Dark cave cell using at most 2 crystals",
    types: ["challenge", "hub3"],
  },
];
