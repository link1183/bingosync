...
bingoList[1] = [
  {
    name: "Banned tr. action: wake from sleep",
    types: ["basic_trigger_tools", "fixing_type"],
  },
  { name: "Max. art shape w/h: 250", types: ["basic_art", "width_height"] },
  {
    name: "Max. editor space: height: 5000",
    types: ["width_height", "editor_limits", "unmatching37"],
  },
  { name: "Max. tr. w/h: 50", types: ["width_height"] },
  {
    name: "Max. vehicle acceleration: 5",
    types: ["vehicles", "vehicle_condition"],
  },
...
bingoList[2] = [
  ...
  {
    name: "Falling obstacles incl.",
    types: ["unmatching1", "unmatching2", "unmatching31"],
  },
  {
    name: "Forced char.: Irresponsible dad",
    types: ["character", "unmatching32"],
  },
  { name: "Forced char.: Segway guy", types: ["character", "unmatching32"] },
  {
    name: "Hide vehicle: false",
    types: ["vehicles", "character", "unmatching13"],
  },
...
bingoList[3] = [
  ...
  {
    name: "Banned tr. action: apply impulse",
    types: ["basic_trigger_tools", "unmatching3"],
  },
  ...
  {
    name: "Max. interactives den.: 10",
    types: ["unmatching2", "basic_interactives", "density"],
  },
  {
    name: "Max. interactives w/h: 1000",
    types: ["width_height", "basic_interactives"],
  },
  {
    name: "Max. text tools: 10 (no customized fonts)",
    types: ["texts", "fonts"],
  },
  { name: "No 'limit rotation/range'", types: ["joints"] },
  {
    name: "No jets attached to vehicles",
    types: ["vehicles", "vehicle_condition", "joints", "unmatching5"],
  },
  { name: "No repeat type 4", types: ["basic_trigger_tools"] },
  { name: "No text rotation", types: ["rotation", "texts"] },
  {
    name: "No triggered by 3",
    types: ["basic_trigger_tools", "unmatching3", "unmatching41"],
  },
...
bingoList[4] = [
  ...
  {
    name: "Banned tr. action: ch. col.",
    types: ["basic_trigger_tools", "collision"],
  },
  {
    name: "Banned tr. action: set to non fixed",
    types: ["basic_trigger_tools", "fixing_type"],
  },
  { name: "Font 1 only", types: ["fonts"] },
  { name: "Main movement: right", types: ["movement", "unmatching38"] },
  {
    name: "Max. editor space: width: 10000",
    types: ["width_height", "editor_limits", "unmatching38"],
  },
  ...
  {
    name: "Min. interactives w/h: 50",
    types: ["width_height", "basic_interactives"],
  },
  { name: "No purplish colors", types: ["basic_art", "colors"] },
  {
    name: "No vehicle linking",
    types: ["vehicles", "vehicle_condition", "joints"],
  },
  {
    name: "No wheel vehicles",
    types: ["vehicles", "vehicle_condition", "joints"],
  },
...
bingoList[5] = [
  {
    name: "Banned tr. action: ch. motor speed",
    types: ["basic_trigger_tools", "joints"],
  },
  { name: "Banned tr. action: delete self", types: ["basic_trigger_tools"] },
  {
    name: "Banned tr. action: set to fixed",
    types: ["basic_trigger_tools", "fixing_type", "unmatching7"],
  },
  { name: "ch. op. time: 3 sec.", types: ["opacity"] },
  {
    name: "Forced char.: Pogostick man",
    types: ["character", "unmatching25", "unmatching35"],
  },
  {
    name: "Forced char.: Wheelchair guy",
    types: ["character", "unmatching25", "unmatching32"],
  },
  ...
  {
    name: "Min. shapes left: 300",
    types: ["editor_limits", "basic_interactives"],
  },
  ...
  {
    name: "Playable char.: Irresponsible dad",
    types: ["character", "unmatching32"],
  },
  ...
  {
    name: "Spikefall incl.",
    types: ["unmatching8", "unmatching27", "unmatching28"],
  },
...
bingoList[6] = [
  ...
  {
    name: "'Collide connected' joints only",
    types: ["vehicles", "collision", "joints"],
  },
  ...
  {
    name: "Min. interactives den.: 10",
    types: ["basic_interactives", "density"],
  },
...
bingoList[7] = [
  ...
  {
    name: "Forced char.: Irresponsible mum",
    types: ["character", "unmatching32"],
  },
...
bingoList[8] = [
  ...
  {
    name: "Banned tr. action: ch. op.",
    types: ["basic_trigger_tools", "opacity"],
  },
  ...
  {
    name: "Interactives den.: 0.1",
    types: ["basic_interactives", "unmatching2", "density"],
  },
  { name: "Intro incl.", types: ["texts"] },
  {
    name: "Max. editor space: height: 2000",
    types: ["width_height", "editor_limits", "unmatching37"],
  },
  ...
  {
    name: "Playable char.: Pogostick man",
    types: ["character", "unmatching25", "unmatching35"],
  },
  {
    name: "Playable char.: Wheelchair guy",
    types: ["character", "unmatching25", "unmatching32"],
  },
  {
    name: "Throwing game incl.",
    types: ["unmatching12", "unmatching13", "unmatching14"],
  },
];
bingoList[9] = [
...
bingoList[10] = [
  ...
  {
    name: "Forced char.: Helicopter man",
    types: ["character", "unmatching25", "unmatching27", "unmatching35"],
  },
...
bingoList[11] = [
  {
    name: "All hazards",
    types: ["unmatching8", "special_items", "unmatching18"],
  },
  ...
  {
    name: "Min. interactives den.: 100",
    types: ["basic_interactives", "density", "unmatching12"],
  },
  { name: "No repeat type 1", types: ["basic_trigger_tools"] },
  { name: "No sliding joints", types: ["vehicles", "joints"] },
  {
    name: "No special items",
    types: ["unmatching5", "unmatching8", "special_items", "unmatching20"],
  },
...
bingoList[13] = [
  ...
  {
    name: "Playable char.: Lawnmower man",
    types: ["character", "unmatching32"],
  },
...
bingoList[14] = [
  ...
  {
    name: "Bright colors only",
    types: ["basic_art", "colors", "unmatching33"],
  },
  {
    name: "Customized char.",
    types: [
      "vehicles",
      "vehicle_condition",
      "character",
  ...
  {
    name: "Horizontal and vertical interactive edges only",
    types: ["basic_interactives", "movement"],
  },
  {
    name: "Main environment: cave",
    types: ["environment", "unmatching19", "unmatching23", "unmatching33"],
  },
  { name: "Main environment: under water", types: ["environment"] },
  {
    name: "Main movement: up",
    types: [
      "movement",
      "unmatching9",
      "unmatching28",
  ...
  {
    name: "Max. art shape w/h: 50",
    types: ["basic_art", "width_height", "environment"],
  },
  {
    name: "Max. editor space: width: 5000",
    types: ["width_height", "editor_limits", "unmatching38"],
  },
  ...
  {
    name: "No rotation (interactives)",
    types: ["rotation", "basic_interactives"],
  },
  ...
  {
    name: "Playable char.: Effective shopper",
    types: ["character", "unmatching32"],
  },
  { name: "Repeat type 3 only", types: ["basic_trigger_tools"] },
  {
    name: "Vehicle ch. during level",
    types: ["vehicles", "vehicle_condition", "character"],
  },
];
bingoList[15] = [
  ...
  {
    name: "Main environment: not on earth",
    types: ["environment", "unmatching23"],
  },
  {
    name: "Min. 20 coins victory",
    types: ["victory", "unmatching20", "unmatching40"],
  },
  {
    name: "Min. art shape w/h: 50",
    types: ["basic_art", "width_height", "unmatching22", "environment"],
  },
  { name: "No saturation (B'n'W)", types: ["basic_art", "colors"] },
  {
    name: "Playable char.: Helicopter man",
    types: ["character", "unmatching25", "unmatching27", "unmatching35"],
  },
  {
    name: "Playable char.: Indiana Jones",
    types: ["character", "unmatching32"],
  },
...
bingoList[16] = [
  {
    name: "Art style: Minimalistic (inverted)",
    types: ["basic_art", "colors"],
  },
  ...
  {
    name: "Max. editor space: height: 1000",
    types: ["width_height", "editor_limits", "unmatching35", "unmatching37"],
  },
  ...
  {
    name: "Repeat type 1 only",
    types: ["basic_trigger_tools", "unmatching41"],
  },
];
bingoList[17] = [
  {
    name: "Customized vehicle char.",
    types: [
      "vehicles",
      "vehicle_condition",
      "character",
  ...
  {
    name: "Playable char.: Santa Claus",
    types: [
      "character",
      "unmatching25",
      "unmatching26",
...
bingoList[18] = [
  ...
  {
    name: "Max. interactives w/h: 50",
    types: ["width_height", "basic_interactives"],
  },
  {
    name: "Min. interactives w/h: 200",
    types: ["width_height", "basic_interactives"],
  },
  { name: "No background art", types: ["basic_art", "environment"] },
  {
    name: "No interactive groups",
    types: ["vehicle_condition", "basic_interactives", "groups"],
  },
  {
    name: "Triggered by 6 only",
    types: ["basic_trigger_tools", "unmatching41"],
  },
];
bingoList[19] = [
  ...
  {
    name: "Min. art left: 9900",
    types: ["basic_art", "editor_limits", "unmatching11", "environment"],
  },
  {
    name: "Tr. not connectable to tr.",
    types: ["basic_trigger_tools", "unmatching41"],
  },
...
bingoList[20] = [
  {
    name: "Blank white background",
    types: ["basic_art", "colors", "environment"],
  },
  {
    name: "Customized walking char.",
    types: [
      "vehicles",
      "vehicle_condition",
      "character",
  ...
  {
    name: "Triggered by 5 only (single triggering)",
    types: [
      "basic_trigger_tools",
      "unmatching6",
      "unmatching7",
...
bingoList[21] = [
  ...
  {
    name: "Max. editor space: height: 500",
    types: ["width_height", "editor_limits", "unmatching35", "unmatching37"],
  },
  {
    name: "No fixed interactives",
    types: ["basic_interactives", "fixing_type", "unmatching34"],
  },
  { name: "No groups", types: ["basic_art", "vehicle_condition", "groups"] },
];
bingoList[22] = [
  {
    name: "3 colors only (+op. banned)",
    types: ["basic_art", "opacity", "colors", "unmatching11"],
  },
  { name: "Complement outlines forced", types: ["basic_art", "colors"] },
  {
    name: "Customized flying char.",
    types: [
      "vehicles",
      "vehicle_condition",
      "character",
  ...
  {
    name: "Max. editor space: width: 1000",
    types: ["width_height", "editor_limits", "unmatching36", "unmatching38"],
  },
  {
    name: "Min. art left: 9980",
    types: ["basic_art", "editor_limits", "unmatching11", "environment"],
  },
  {
    name: "Min. art shape w/h: 100",
    types: ["basic_art", "width_height", "unmatching22", "environment"],
  },
...
bingoList[23] = [
  ...
  {
    name: "Min. shapes left: 700",
    types: ["editor_limits", "basic_interactives"],
  },
  {
    name: "Tr. only connectable to tr.",
    types: [
      "basic_trigger_tools",
      "unmatching6",
      "unmatching7",
...
bingoList[24] = [
  {
    name: "2 colors only (+op. banned)",
    types: ["basic_art", "opacity", "colors", "unmatching11"],
  },
  {
    name: "No activate object tr.",
    types: ["basic_trigger_tools", "unmatching41"],
  },
  {
    name: "No art shapes",
...
bingoList[25] = [
  ...
  {
    name: "Pure black/white only (+op. banned)",
    types: ["basic_art", "opacity", "colors", "unmatching11"],
  },
];
