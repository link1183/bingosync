...
bingoList[2] = [
  ...
  {
    name: "Complete Forsaken City with Low Friction",
    types: ["1a", "1b", "low_friction"],
  },
...
bingoList[3] = [
  ...
  {
    name: "Complete Old Site with Low Friction",
    types: ["2a", "2b", "low_friction"],
  },
];
bingoList[4] = [
...
bingoList[6] = [
  {
    name: "Complete Old Trail with Low Friction",
    types: ["4a", "low_friction"],
  },
  { name: "100% Pico-8", types: ["3a"] },
  {
    name: "Complete Presidential Suite with Low Friction",
    types: ["3a", "low_friction"],
  },
  { name: "Bop Oshiro 10 Times in Two Chapters", types: ["3a", "3b"] },
  {
    name: "All Berries in Start and Depths of 5A (23)",
    types: ["5a", "big_berries", "full_clear"],
  },
];
bingoList[7] = [
  { name: "Invisible Huge Mess", types: ["3a", "invisible"] },
  {
    name: "Complete Elevator Shaft with Low Friction",
    types: ["3a", "low_friction"],
  },
...
bingoList[8] = [
  ...
  {
    name: "Bop Seekers 10 Times in 2 Chapters",
    types: ["5a", "5b", "seekers"],
  },
];
bingoList[9] = [
  ...
  {
    name: "Complete 3A Start with Low Friction",
    types: ["3a", "low_friction"],
  },
  { name: "Invisible Unravelled", types: ["5a", "invisible"] },
  { name: "Invisible Cliff Face", types: ["4a", "invisible"] },
  {
    name: "Complete Start of Mirror Temple with Low Friction",
    types: ["5a", "5b", "low_friction"],
  },
];
bingoList[10] = [
  {
    name: "Invisible Start of Celestial Resort",
    types: ["3a", "3b", "invisible"],
  },
  { name: "Invisible Old Site", types: ["2a", "2b", "invisible"] },
  {
    name: "Grabless Huge Mess with the Heart",
    types: ["3a", "grabless", "hearts"],
  },
...
bingoList[11] = [
  ...
  {
    name: "Complete Mirror Temple with Low Friction",
    types: ["5a", "5b", "low_friction"],
  },
];
bingoList[12] = [
  {
    name: "Kill 3 Different Seekers in Two Chapters",
    types: ["5a", "5b", "seekers", "b-sides"],
  },
  {
    name: "Blue and Red Heart in Celestial Resort",
    types: ["3a", "3b", "hearts", "b-sides"],
  },
...
bingoList[15] = [
  ...
  {
    name: "Every Different Seeker Kill (12)",
    types: ["5a", "5b", "seekers", "b-sides"],
  },
];
bingoList[16] = [
  ...
  {
    name: "Use 4 Binoculars in 8 Chapters",
    types: ["binos", "farewell", "b-sides"],
  },
...
bingoList[18] = [
  {
    name: "Complete 5 Chapters with Low Friction",
    types: ["low_friction", "big_chapters"],
  },
...
bingoList[19] = [
  ...
  {
    name: "Complete 2B Grabless",
    types: ["2b", "grabless", "b-sides", "hearts"],
  },
...
bingoList[20] = [
  ...
  {
    name: "Complete 6 Chapters Invisible",
    types: ["big_chapters", "invisible"],
  },
  {
    name: "Use All Binoculars in B-Sides (13)",
    types: ["b-sides", "binos", "6b", "7b"],
  },
];
bingoList[21] = [
  {
    name: "Use 20 Binoculars in Farewell",
    types: ["binos", "farewell", "late_farewell"],
  },
  { name: "10 Hearts", types: ["hearts"] },
  { name: "6 Hearts and 6 Cassettes", types: ["hearts", "b-sides"] },
  {
    name: "Blue and Red Heart in Reflection",
    types: ["6a", "6b", "hearts", "b-sides"],
  },
...
bingoList[22] = [
  ...
  {
    name: "Blue and Red Heart in The Summit",
    types: ["hearts", "b-sides", "7a", "7b"],
  },
  {
    name: "Complete Remembered with Low Friction",
    types: ["farewell", "low_friction"],
  },
];
bingoList[23] = [
  {
    name: "25 Berries in 4 Chapters",
    types: ["very_big_berries", "full_clear"],
  },
  { name: "Determination Demo Room", types: ["farewell", "late_farewell"] },
  {
    name: "20 Berries in 5 Chapters",
    types: ["very_big_berries", "full_clear"],
  },
  { name: "Complete 10 Chapters", types: ["big_chapters"] },
  {
    name: "4 A-Sides and 4 B-Sides",
    types: ["big_chapters", "hearts", "b-sides"],
  },
];
bingoList[24] = [
