...
bingoList[8] = [
  ...
  {
    name: "Defeat Furko Nellis's Tournament Deck",
    types: ["Pazaak", "Tatooine"],
  },
  {
    name: "Solari Crystal",
    types: ["Crystal", "Korriban", "Hunt", "AlignedItem"],
  },
...
bingoList[9] = [
  {
    name: "Fully Upgraded Mission's Vibroblade",
    types: ["Mission", "Upgrade"],
  },
  ...
  {
    name: "Strand Zaalbar on Kashyyyk",
    types: ["Kashyyyk", "Zaalbar", "Party"],
  },
];
bingoList[10] = [
  ...
  {
    name: "One Droid with Upgrade Class 3",
    types: ["Character", "HK", "T3", "Party"],
  },
...
bingoList[12] = [
  ...
  {
    name: "Give Griff a Tach Gland",
    types: ["Tatooine", "Mission", "Kashyyyk"],
  },
  { name: "Master Caution, Empathy, and Gear Head", types: ["Character"] },
  {
    name: "Three Viper Kinrath Corpses",
    types: ["Kashyyyk", "Zaalbar", "Hunt"],
  },
  {
    name: "Fully Upgraded Bendak's Blaster",
    types: ["Taris", "Bounty", "Upgrade", "Blasters"],
  },
...
bingoList[14] = [
  ...
  {
    name: "GenoHaradan Stealth Unit",
    types: ["Tatooine", "Bounty", "Geno", "Belts"],
  },
...
bingoList[15] = [
  ...
  {
    name: "Talk to Yuthura on Dantooine",
    types: ["Korriban", "Dantooine", "Redeem"],
  },
  {
    name: "Recruit All Party Members",
    types: ["Party", "Mission", "Zaalbar", "Juhani", "Jolee", "HK", "T3"],
  },
  { name: "One of All 4 Deadly Mines", types: [] },
];
bingoList[16] = [
  {
    name: "Have Sunry Declared Innocent",
    types: ["Kashyyyk", "Manaan", "Murder", "Party", "Jolee"],
  },
...
bingoList[17] = [
  ...
  {
    name: "All 4 Sith Lord Artifacts",
    types: ["Tombs", "Korriban", "AlignedItem"],
  },
...
bingoList[18] = [
  ...
  {
    name: "Zaalbar Wielding Bacca's Ceremonial Blade",
    types: ["Zaalbar", "Kashyyyk"],
  },
  {
    name: "13 Unique Lightsaber Power Crystals",
    types: ["Crystal", "Collect"],
  },
...
bingoList[20] = [
  {
    name: "Resolve All Party Family Disputes",
    types: ["Party", "Mission", "Zaalbar", "Family"],
  },
  ...
  {
    name: "Redeem Four Sith to the Light",
    types: ["Korriban", "Tombs", "Redeem"],
  },
];
bingoList[21] = [
  { name: "Kill Saul Karath", types: ["Bosses", "Leviathan"] },
  {
    ...
    types: ["Armband", "Verpine", "Leviathan"],
  },
...
bingoList[23] = [
  ...
  {
    name: "Kill Calo, Davik, Bandon, and Saul",
    types: ["Leviathan", "Bosses"],
  },
...
bingoList[25] = [
  ...
  {
    name: "Complete All 9 Companion Sidequests",
    types: ["Party", "Zaalbar", "Juhani", "Mission", "Jolee", "HK", "T3"],
  },
