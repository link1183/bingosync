...
bingoGenerator = function (bingoList, opts) {
  ...
  for (var i = 1; i <= 25; i++) {
    ...
    for (var key in bingoList[randomkey]["excludes"]) {
      ...
      if (bingoList.hasOwnProperty(exc)) delete bingoList[exc];
    }
...
var bingoList = {
  ...
  Tram: {
    Name: "Tram Pass + Visit all 5 Tram Stations",
    excludes: ["Hiveblood", "HiveHeart", "HiveKnight"],
  },
  ...
  Fountain: {
    Name: "Obtain fountain vessel fragment",
    excludes: ["3000", "4000"],
  },
  ...
  CrestElevator: {
    Name: "Use City Crest + Ride both CoT large elevators",
    excludes: [],
  },
  Lemm: {
    Name: "Talk to Lemm with Crest Equipped",
    excludes: ["Dung", "DCrest"],
  },
  Bank: { Name: "Have 1500 geo in the bank", excludes: [] },
  420: {
    Name: "Break the 420 geo rock in Kingdom's Edge",
    excludes: ["QSlash"],
  },
  ...
  Pins: {
    Name: "Buy 6 map pins from Iselda (All but two)",
    excludes: ["PinsAll"],
  },
  PinsAll: { Name: "Buy 8 map pins from Iselda (All)", excludes: ["Pins"] },
  KingStag: {
    Name: "Unlock Queen's Stag + King's Stag Stations",
    excludes: [],
  },
  HornetMom: {
    Name: "Talk to Hornet at CoT Statue + Herrah",
    excludes: ["Herrah"],
  },
  ...
  ThornsTrio: {
    Name: "Thorns of agony + Baldur Shell + Spore Shroom",
    excludes: [],
  },
  ...
  Emily: {
    Name: "Talk to Emilitia (shortcut out of sewers)",
    excludes: ["Tear"],
  },
  ...
  Hiveblood: {
    Name: "Hiveblood",
    excludes: ["HiveHeart", "Tram", "HiveKnight"],
  },
  HiveKnight: {
    Name: "Hive Knight",
    excludes: ["HiveHeart", "Hiveblood", "Tram"],
  },
  HiveHeart: {
    Name: "Mask Shard  in the Hive",
    excludes: ["Hiveblood", "Tram", "HiveKnight"],
  },
  Revek: {
    Name: "Parry Revek 3 times without dying (Glade of Hope Guard)",
    excludes: [],
  },
  Tendrils: {
