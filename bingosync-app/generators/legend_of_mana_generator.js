...
bingoList[2] = [
  ...
  {
    name: "Complete 10 events",
    types: ["Events", "EventsF", "EventsD", "EventsJ"],
  },
  { name: "Place 10 artifacts", types: ["Land"] },
  { name: "Have 2 pets", types: ["Pet"] },
  { name: "Reach level 15", types: ["Level"] },
  {
    name: "Complete 1 Dragon events (splashscreen)",
    types: ["EventsD", "Dragon"],
  },
  {
    name: "5 entries in the cactus diary",
    types: ["Events", "Cactus", "EventsF", "EventsD", "EventsJ"],
  },
...
bingoList[3] = [
  ...
  {
    name: "10 entries in the cactus diary",
    types: ["Events", "Cactus", "EventsF", "EventsD", "EventsJ"],
  },
...
bingoList[4] = [
  ...
  {
    name: "Complete 2 Dragon events (splashscreen)",
    types: ["EventsD", "Dragon"],
  },
  {
    name: "Looking Glass Tower/Two Pearls with no teleport gem",
    types: ["TeleGem", "Fairy"],
  },
];
...
bingoList[5] = [
  ...
  {
    name: "15 entries in the cactus diary",
    types: ["Events", "Cactus", "EventsF", "EventsD", "EventsJ"],
  },
...
bingoList[7] = [
  ...
  {
    name: "Complete 3 Dragon events (splashscreen)",
    types: ["EventsD", "Dragon"],
  },
  { name: "Beat a boss with Daena", types: ["Boss", "Fairy"] },
  {
    name: "Complete 1 Fairy events (splashscreen)",
    types: ["EventsF", "Fairy"],
  },
...
bingoList[9] = [
  ...
  {
    name: "Complete 2 Fairy events (splashscreen)",
    types: ["EventsF", "Fairy"],
  },
];
...
bingoList[11] = [
  ...
  {
    name: "20 entries in the cactus diary",
    types: ["Events", "Cactus", "EventsF", "EventsD", "EventsJ"],
  },
  {
    name: "Complete 4 Dragon events (splashscreen)",
    types: ["EventsD", "Dragon"],
  },
  {
    name: "Complete 3 Fairy events (splashscreen)",
    types: ["EventsF", "Fairy"],
  },
];
...
bingoList[13] = [
  {
    name: "Complete 4 Fairy events (splashscreen)",
    types: ["EventsF", "Fairy"],
  },
...
bingoList[18] = [
  {
    name: "25 entries in the cactus diary",
    types: ["Events", "Cactus", "EventsF", "EventsD", "EventsJ"],
  },
...
bingoList[19] = [
  {
    name: "Complete 30 events",
    types: ["Events", "EventsF", "EventsD", "EventsJ"],
  },
  { name: "Legend of Mana", types: ["Events"] },
  {
    name: "Complete All Gilbert events",
    types: ["Special", "Events", "Gilbert"],
  },
];
...
bingoList[20] = [
  ...
  {
    name: "Complete All Niccolo events",
    types: ["Special", "Events", "Niccolo"],
  },
...
bingoList[21] = [
  {
    name: "Complete 35 events",
    types: ["Events", "EventsF", "EventsD", "EventsJ"],
  },
  { name: "End with 0 Lucre", types: ["Lucre"] },
  {
    name: "30 entries in the cactus diary",
    types: ["Events", "Cactus", "EventsF", "EventsD", "EventsJ"],
  },
];
...
bingoList[22] = [
  {
    name: "Complete All pirate events",
    types: ["Special", "Events", "Pirate"],
  },
...
bingoList[24] = [
  {
    name: "Complete 40 events",
    types: ["Events", "EventsF", "EventsD", "EventsJ"],
  },
  { name: "Get all encyclopedias", types: ["Encyclopedia"] },
  {
    name: "Complete All Diddle events",
    types: ["Special", "Events", "Diddle"],
  },
