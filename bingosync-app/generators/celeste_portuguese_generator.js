...
bingoList[2] = [
  ...
  {
    name: "Todos os 8 Morangos na Intervenção (2A-2)",
    types: ["checkpoint_berries"],
  },
  {
    name: "Complete a Desperta sem usar dash (2A-3)",
    types: ["earlygame", "awake"],
  },
  {
    name: "Todos os 9 Morangos no Início da 2A",
    types: ["checkpoint_berries"],
  },
  { name: "Cassete da 2A", types: ["2b", "earlygame"] },
  {
    name: "Complete o Abismo sem usar dash (1A-3)",
    types: ["earlygame", "task"],
  },
];
bingoList[3] = [
  ...
  {
    name: "Fale com o Theo no Poço do Elevador (3A-3)",
    types: ["resort_cutscene", "cutscene"],
  },
  {
    name: "Completar Intervenção sem pular (2A-2)",
    types: ["earlygame", "task"],
  },
  {
    name: "Todos os 9 Morangos na Travessia (1A-2)",
    types: ["checkpoint_berries"],
  },
  { name: "10 Morangos na 2A", types: ["amount_berries"] },
  {
    name: "Encontre a Carta e o PICO-8 na 3A",
    types: ["resort_cutscene", "cutscene"],
  },
...
bingoList[4] = [
  ...
  {
    name: "Complete a Travessia sem usar dash (1A-2)",
...
bingoList[5] = [
  ...
  {
    name: "Todos os 4 Morangos no Poço do Elevador",
    types: ["checkpoint_berries"],
  },
...
bingoList[6] = [
  {
    name: "Todos os 7 Morangos na Grande Bagunça",
    types: ["checkpoint_berries"],
  },
  ...
  {
    name: "Todos os 3 Morangos na Suíte Presidencial",
    types: ["checkpoint_berries"],
  },
  { name: "Cassete da 5A", types: ["5b"] },
  {
    name: "Grande Bagunça: Baú -> Livros -> Toalha",
    types: ["huge_mess_pathing"],
  },
  {
    name: "Grande Bagunça: Baú -> Toalha -> Livros",
    types: ["huge_mess_pathing"],
  },
  {
    name: "Grande Bagunça: Toalha -> Livros -> Baú",
    types: ["huge_mess_pathing"],
  },
...
bingoList[7] = [
  ...
  {
    name: "Leia o Diário no Poço do Elevador (3A-3)",
    types: ["resort_cutscene", "cutscene"],
  },
  { name: "Poço do Elevador sem agarrar (3A-3)", types: ["grabless"] },
  {
    name: "Todos os 8 Morangos no Início da 4A",
    types: ["checkpoint_berries"],
  },
...
bingoList[8] = [
  {
    name: "Todos os 7 Morangos na Antiga Trilha (4A-3)",
    types: ["checkpoint_berries"],
  },
  ...
  {
    name: "Grande Bagunça: Livros -> Toalha -> Baú",
    types: ["huge_mess_pathing"],
  },
  {
    name: "Grande Bagunça: Livros -> Baú -> Toalha",
    types: ["huge_mess_pathing"],
  },
  {
    name: "Grande Bagunça: Toalha -> Baú -> Livros",
    types: ["huge_mess_pathing"],
  },
...
bingoList[10] = [
  ...
  {
    name: "Todos os 5 Morangos na Face do Penhasco",
    types: ["checkpoint_berries"],
  },
...
bingoList[12] = [
  ...
  {
    name: "Todos os 12 Morangos no Início da 5A",
    types: ["checkpoint_berries"],
  },
  {
    name: "Todos os 11 Morangos no Início da 3A",
    types: ["checkpoint_berries"],
  },
  {
    name: "Todos os 9 Morangos no Templo (4A-2)",
    types: ["checkpoint_berries"],
  },
...
bingoList[13] = [
  ...
  {
    name: "2 Corações Azuis e 2 Corações Vermelhos",
  ...
  {
    name: "1 Morango em No Núcleo (8A-2)",
...
bingoList[14] = [
  ...
  {
    name: "Ir só pela rota de cima na Ravina (6A-3)",
...
bingoList[15] = [
  ...
  {
    name: "Todos os 11 Morangos nas Profundezas (5A-2)",
    types: ["checkpoint_berries"],
  },
  {
    name: "Todos os 6 Morangos na Procura (5A-4)",
    types: ["checkpoint_berries"],
  },
...
bingoList[16] = [
  ...
  {
    name: "Ir só pela rota de baixo na Ravina (6A-3)",
    types: ["task", "reflection_pathing"],
  },
...
bingoList[18] = [
  ...
  {
    name: "3 Corações Azuis e 3 Corações Vermelhos",
    types: ["amount_hearts", "amount_chapters"],
  },
  {
    name: "Complete 2 Capítulos sem agarrar",
...
bingoList[19] = [
  ...
  {
    name: "1 Morango em O Coração da Montanha (8A-4)",
    types: ["checkpoint_berries", "core"],
  },
  {
    name: "Use todos os 3 Binóculos nos 500M",
...
bingoList[20] = [
  ...
  {
    name: "Fundo do Poço sem agarrar (6A-5 ou 6B-3)",
    types: ["lategame", "grabless"],
  },
...
bingoList[22] = [
  ...
  {
    name: "Use todos os 4 Binóculos nos 1000M",
    types: ["binoculars", "lategame"],
  },
];
bingoList[23] = [
...
bingoList[25] = [
  ...
  {
    name: "15 Morangos em 4 Capítulos",
    types: ["amount_berries", "big_berries"],
  },
  { name: "Entre no Horizonte de Eventos (9-4)", types: ["ch9"] },
  {
    name: "Todos os Colecionáveis do 8A",
    types: ["checkpoint_berries", "core"],
  },
