...
var bingoList = [
  [
    ...
    },
    {
      ...
      types: ["Clear conditions"],
    },
    {
      name: "Finish a level while holding a koopa shell",
      types: ["Finish a level in X"],
    },
    {
  ...
  [
    ...
    },
    {
      ...
      types: ["Online Multiplayer goals"],
    },
  ],
  [
    {
  ...
  [
    {
      ...
      types: ["Beat a level in under X seconds"],
    },
    {
  ...
  [
    {
      ...
      types: ["Beat X Levels in Y Difficulty"],
    },
    {
  ...
  [
    ...
    },
    {
      ...
      types: ["Have X lives in X difficulty"],
    },
    {
