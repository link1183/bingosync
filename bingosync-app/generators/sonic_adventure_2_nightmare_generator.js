...
bingoList[1] = [
  ...
  {
    name: "Collect 10 hidden animals on City Escape M1 and finish",
    types: ["hero", "animals"],
  },
  { name: "Iron Gate M1 with 0 A inputs", types: ["dark", "abc"] },
  {
    name: "Collect 10 hidden animals on Iron Gate M1 and finish",
    types: ["dark", "animals"],
  },
  {
    name: "Get speedshoes thrice on single level and finish",
    types: ["multistory"],
  },
  {
    name: "Get Magnetic Shield thrice on single level and finish",
    types: ["multistory"],
  },
];
bingoList[2] = [
  ...
  {
    name: "Collect 10 hidden animals on Dry Lagoon M1 and finish",
    types: ["dark", "animals"],
  },
];
bingoList[3] = [
  {
    name: "A-rank on 3 Shadow/Sonic missions (Team Combined)",
    types: ["multistory"],
  },
  ...
  {
    name: "Collect 10 hidden animals on Sand Ocean M1 and finish",
    types: ["dark", "animals"],
  },
  {
    name: "3 Chao Boxes on Sand Ocean M1 and finish",
    types: ["dark", "boxes"],
  },
];
bingoList[4] = [
  ...
  {
    name: "Eliminate 9 enemies on Wild Canyon M4 and finish",
    types: ["hero", "genocide"],
  },
  {
    name: "Collect 10 hidden animals on Wild Canyon M3 and finish",
    types: ["hero", "animals"],
  },
  { name: "Beat Shadow 1 with 9 rings", types: ["hero", "ra"] },
  {
    name: "Destroy 3 planes on Radical Highway M1 and finish",
    types: ["dark"],
  },
  {
    name: "3 Chao Boxes on Radical Highway M1 and finish",
    types: ["dark", "boxes"],
  },
  {
    name: "3 Chao Boxes on Dry Lagoon M3 and finish",
    types: ["dark", "boxes"],
  },
];
bingoList[5] = [
  ...
  {
    name: "Metal Harbor M2 without checkpoints",
    types: ["hero", "checkpointless"],
  },
  { name: "Metal Harbor M2 with 0 A inputs", types: ["hero", "abc"] },
  { name: "Egg Quarters M1 with 0 A inputs", types: ["dark", "abc"] },
  {
    name: "Eliminate 14 enemies on Egg Quarters and finish",
    types: ["dark", "genocide"],
  },
...
bingoList[6] = [
  {
    name: "Eliminate 7 enemies on Pumpkin Hill and finish",
    types: ["hero", "genocide"],
  },
  { name: "Pumpkin Hill M1 with 0 A inputs", types: ["hero", "abc"] },
  { name: "Green Forest M2 with 0 A inputs", types: ["hero", "abc"] },
  {
    name: "3 Chao Boxes on Egg Quarters M2 and finish",
    types: ["dark", "boxes"],
  },
  {
    name: "Get Life Capsule on Radical Highway M3 and finish (deathless)",
    types: ["dark"],
  },
  {
    name: "Collect 10 hidden animals on Lost Colony M1 and finish",
    types: ["dark", "animals"],
  },
];
bingoList[7] = [
  ...
  {
    name: "Collect 10 hidden animals on Metal Harbor M4 and finish",
    types: ["hero", "animals"],
  },
  { name: "Mission Street M1 ringless", types: ["hero", "ringless"] },
  {
    name: "Collect 10 hidden animals on Radical Highway M4 and finish",
    types: ["dark", "animals"],
  },
  {
    name: "Collect 10 hidden animals on Weapons Bed M1 and finish",
    types: ["dark", "animals"],
  },
...
bingoList[8] = [
  {
    name: "Eliminate 5 enemies on Aquatic Mine and finish",
    types: ["hero", "genocide"],
  },
  { name: "Aquatic Mine M1 with 0 A inputs", types: ["hero", "abc"] },
  { name: "Metal Harbor M5 Pacifist", types: ["hero", "pacifist"] },
  {
    name: "Collect 10 hidden animals on Green Forest M4 and finish",
    types: ["hero", "animals"],
  },
  {
    name: "Collect 4 Life Capsules on Green Forest M4 and finish",
    types: ["hero"],
  },
  { name: "Radical Highway M5 Pacifist", types: ["dark", "pacifist"] },
  {
    name: "3 Chao Boxes on Weapons Bed M2 and finish",
    types: ["dark", "boxes"],
  },
...
bingoList[9] = [
  ...
  {
    name: "Collect 3 Life Capsules on Prison Lane M1 and finish",
    types: ["hero"],
  },
  {
    name: "3 Chao Boxes on Mission Street M3 and finish",
    types: ["hero", "boxes"],
  },
  {
    name: "Eliminate 16 enemies on Security Hall and finish",
    types: ["dark", "genocide"],
  },
  {
    name: "3 Chao Boxes on Lost Colony M4 and finish",
    types: ["dark", "boxes"],
  },
...
bingoList[10] = [
  ...
  {
    name: "Collect 10 hidden animals on Green Forest M5 and finish",
    types: ["hero", "animals"],
  },
  { name: "Green Forest M5 Pacifist", types: ["hero", "pacifist"] },
  {
    name: "Collect 10 hidden animals on Mission Street M4 and finish",
    types: ["hero", "animals"],
  },
  { name: "Flying Dog with 0 A inputs", types: ["dark", "abc"] },
  { name: "Beat Flying Dog with 26 rings", types: ["dark", "ra"] },
  {
    name: "Collect Magnetic Shield on Lost Colony M5 and finish",
    types: ["dark"],
  },
...
bingoList[11] = [
  {
    name: "Aquatic Mine M5 deathless and ringless",
    types: ["hero", "ringless"],
  },
  {
    name: "Eliminate 15 enemies on Pyramid Cave and finish",
    types: ["hero", "genocide"],
  },
  { name: "Pyramid Cave M1 ringless", types: ["hero", "ringless"] },
  {
    name: "Hidden Base M2 without checkpoints",
    types: ["hero", "checkpointless"],
  },
  { name: "Route 101 M3 ringless", types: ["hero", "ringless"] },
  {
    name: "Collect 10 hidden animals on Prison Lane M4 and finish",
    types: ["hero", "animals"],
  },
  ...
  {
    name: "3 Chao Boxes on White Jungle M1 and finish",
    types: ["dark", "boxes"],
  },
...
bingoList[12] = [
  {
    name: "3 Chao Boxes on Death Chamber M1 and finish",
    types: ["hero", "boxes"],
  },
  {
    name: "Pyramid Cave M2 without checkpoints",
    types: ["hero", "checkpointless"],
  },
  {
    name: "Collect 10 hidden animals on Hidden Base M3 and finish",
    types: ["hero", "animals"],
  },
  { name: "White Jungle M2 with 0 A inputs", types: ["dark", "abc"] },
  { name: "Beat Sonic 1 with 9 rings", types: ["dark", "ra"] },
  {
    name: "3 Chao Boxes on Security Hall M4 and finish",
    types: ["dark", "boxes"],
  },
];
bingoList[13] = [
  {
    name: "Death Chamber M2 without Mystic Melody and Sunglasses",
    types: ["hero"],
  },
  { name: "Beat King Boom Boo with 24 rings", types: ["hero", "ra"] },
  { name: "Pyramid Cave M3 without using Bounce Bracelet", types: ["hero"] },
  {
    name: "Security Hall M5 deathless and ringless",
    types: ["dark", "ringless"],
  },
  { name: "Security Hall M5 Pacifist", types: ["dark", "pacifist"] },
  {
    name: "Collect Green Shield while you already own Magnetic Shield",
    types: ["multistory"],
  },
...
bingoList[14] = [
  ...
  {
    name: "Collect 6 Life Capsules on Pyramid Cave M4 and finish",
    types: ["hero"],
  },
  {
    name: "Collect 10 hidden animals on Pyramid Cave M4 and finish",
    types: ["hero", "animals"],
  },
  ...
  {
    name: "Collect 10 hidden animals on White Jungle M4 and finish",
    types: ["dark", "animals"],
  },
  {
    name: "Collect 3 Life Capsules on White Jungle M4 and finish",
    types: ["dark"],
  },
];
bingoList[15] = [
  ...
  {
    name: "Collect 15 hidden animals on Pyramid Cave M5 and finish",
    types: ["hero", "animals"],
  },
...
bingoList[16] = [
  {
    name: "Eliminate 7 enemies on Meteor Herd and finish",
    types: ["hero", "genocide"],
  },
  {
    name: "Collect 6 Life Capsules on Meteor Herd and finish",
    types: ["hero"],
  },
  {
    name: "Eternal Engine M2 without checkpoints",
    types: ["hero", "checkpointless"],
  },
  {
    name: "Eliminate 7 enemies on Mad Space and finish",
    types: ["dark", "genocide"],
  },
  { name: "Sky Rail M3 with 0 A inputs", types: ["dark", "abc"] },
  { name: "Route 280 M3 ringless", types: ["dark", "ringless"] },
  {
    name: "Win all kart races as Tails/Rouge without rings boost",
    types: ["multistory"],
  },
];
bingoList[17] = [
  ...
  {
    name: "Collect 10 hidden animals on Sky Rail M4 and finish",
    types: ["dark", "animals"],
  },
  ...
  {
    name: "Route 280 M5 or Route 101 M5 without hitting cars",
    types: ["multistory"],
  },
];
bingoList[18] = [
  {
    name: "Collect 10 hidden animals on Eternal Engine M4 and finish",
    types: ["hero", "animals"],
  },
  {
    name: "Eliminate 9 enemies in Crazy Gadget's puzzle room and finish",
    types: ["hero", "genocide"],
  },
  {
    name: "3 Chao Boxes on Meteor Herd M3 and finish",
    types: ["hero", "boxes"],
  },
...
bingoList[19] = [
  ...
  {
    name: "Crazy Gadget M2 without checkpoints",
    types: ["hero", "checkpointless"],
  },
  { name: "Beat Tails 2 with 0 A inputs", types: ["dark", "abc"] },
  {
    name: "Eliminate 8 enemies on Dry Lagoon M4 and finish",
    types: ["dark", "genocide"],
  },
  {
    name: "Collect 3 Life Capsules on Mad Space M4 and finish",
    types: ["dark"],
  },
  {
    name: "Collect Chao Key on every level (Team Combined)",
    types: ["multistory"],
  },
];
bingoList[20] = [
  {
    name: "Collect 13 Life Capsules on Final Rush M1 and finish",
    types: ["hero"],
  },
  {
    name: "Eliminate 17 enemies on Final Rush and finish",
    types: ["hero", "genocide"],
  },
  { name: "Every Sonic's M1 A-rank", types: ["hero"] },
  { name: "Every Shadow's M1 A-rank", types: ["dark"] },
  {
    name: "Collect 10 hidden animals on Cosmic Wall M2 and finish",
    types: ["dark", "animals"],
  },
...
bingoList[21] = [
  ...
  {
    name: "Final Rush M2 without checkpoints",
    types: ["hero", "checkpointless"],
  },
  {
    name: "Collect 10 hidden animals on Crazy Gadget M4 and finish",
    types: ["hero", "animals"],
  },
  { name: "Final Chase M2 without using Homing Attack", types: ["dark"] },
  {
    name: "Cosmic Wall M3 Pacifist and ringless",
    types: ["dark", "pacifist", "ringless"],
  },
  {
    name: "Game Over on Shadow 2 or Sonic 2 with 99 rings",
    types: ["multistory"],
  },
];
bingoList[22] = [
  {
    name: "3 Chao Boxes on City Escape M5 and finish",
    types: ["hero", "boxes"],
  },
  { name: "Crazy Gadget M5 with Magnetic Shield", types: ["hero"] },
  {
    name: "3 Chao Boxes on Crazy Gadget M5 and finish",
    types: ["hero", "boxes"],
  },
  {
    name: "3 Chao Boxes on Cosmic Wall M4 and finish",
    types: ["dark", "boxes"],
  },
...
bingoList[23] = [
  {
    name: "Collect 10 hidden animals on Final Rush M4 and finish",
    types: ["hero", "animals"],
  },
  { name: "Complete every Knuckles' M4 hintless", types: ["hero"] },
  {
    name: "Collect 10 Life Capsules on Final Chase M4 and finish",
    types: ["dark"],
  },
...
bingoList[24] = [
  ...
  {
    name: "Dark Story Boss Rush ringless (1 ring EG permitted)",
    types: ["dark", "ringless"],
  },
  {
    name: "Collect Magnetic Shield on Cosmic Wall M5 and finish",
    types: ["dark"],
  },
  { name: "70 Emblems", types: ["multistory"] },
  {
    name: "Final Rush M3 or Final Chase M3 with 700+ rings",
    types: ["multistory"],
  },
];
bingoList[25] = [
  {
    name: "3 Chao Boxes on FR or FC M5 and finish",
    types: ["multistory", "boxes"],
  },
