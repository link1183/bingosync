...
bingoList[1] = [
  ...
  {
    name: "Complete City Escape M1 with a Magnetic Shield",
    types: ["cityescape"],
  },
  ...
  {
    name: "Magnetic Shield twice in any level and finish",
    types: ["multistory"],
  },
];
bingoList[2] = [
...
bingoList[3] = [
  ...
  {
    name: "Unlock Chao Garden for all Hero Story characters",
    types: ["chaogarden"],
  },
  {
    name: "Complete Metal Harbor via the Upper Handle of the Rocket",
    types: ["metalharbor"],
  },
...
bingoList[4] = [
  ...
  {
    name: "Destroy the Gold Beetle in 3 Hero Story stages",
    types: ["goldbeetle"],
  },
  {
    name: "Wild Canyon All Missions A-Rank",
    types: ["wildcanyon", "arank", "allmissions"],
  },
  {
    name: "Complete Prison Lane M1 with a Green Shield",
    types: ["prisonlane"],
  },
];
bingoList[5] = [
  ...
  {
    name: "Finish any mission with 25+ Lives (No Underflow)",
    types: ["multistory"],
  },
];
bingoList[6] = [
  ...
  {
    name: "Dry Lagoon All Missions A-Rank",
    types: ["drylagoon", "arank", "allmissions"],
  },
  ...
  {
    name: "5 hidden animals in Metal Harbor and finish",
    types: ["metalharbor"],
  },
  { name: "Pacifist Metal Harbor M1", types: ["metalharbor"] },
  {
    name: "Unlock Chao Garden for all Dark Story characters",
    types: ["chaogarden"],
  },
...
bingoList[7] = [
  {
    name: "City Escape All Missions A-Rank",
    types: ["cityescape", "arank", "allmissions"],
  },
  { name: "Metal Harbor M3 B-Rank", types: ["metalharbor", "brank"] },
  { name: "Radical Highway M2", types: ["radicalhighway"] },
  {
    name: "Complete Radical Highway M1 with 100+ Rings",
    types: ["radicalhighway"],
  },
  {
    name: "2 Chao Boxes in Radical Highway and finish",
    types: ["radicalhighway"],
  },
  {
    name: "5 hidden animals in Radical Highway and finish",
    types: ["radicalhighway"],
  },
  {
    name: "Destroy the Gold Beetle in 3 Dark Story stages",
    types: ["goldbeetle"],
  },
...
bingoList[9] = [
  ...
  {
    name: "5 hidden animals in Egg Quarters and finish",
    types: ["eggquarters"],
  },
  {
    name: "Complete Egg Quarters M1 with a Magnetic Shield",
    types: ["eggquarters"],
  },
  ...
  {
    name: "5 hidden animals in Green Forest and finish",
    types: ["greenforest"],
  },
  { name: "Pacifist Green Forest M1", types: ["greenforest"] },
  {
    name: "Complete Green Forest M1 with a Magnetic Shield",
    types: ["greenforest"],
  },
...
bingoList[10] = [
  ...
  {
    name: "Lose a Life to a Golden Beetle in 3 Different Stages",
    types: ["goldbeetle", "multistory"],
  },
];
bingoList[11] = [
  {
    name: "Metal Harbor All Missions A-Rank",
    types: ["metalharbor", "arank", "allmissions"],
  },
  ...
  {
    name: "5 hidden animals in Pumpkin Hill and finish",
    types: ["pumpkinhill"],
  },
  { name: "Pumpkin Hill M3", types: ["pumpkinhill"] },
  { name: "Egg Quarters M4", types: ["eggquarters"] },
  {
    name: "Destroy the Gold Beetle in 5 different stages",
    types: ["goldbeetle", "multistory"],
  },
];
bingoList[12] = [
...
bingoList[13] = [
  ...
  {
    name: "Game Over during Mission Street M1",
    types: ["missionstreet", "gameover"],
  },
  { name: "Iron Gate M3", types: ["irongate"] },
  {
    name: "Unlock Chao Garden for every character",
    types: ["chaogarden", "multistory"],
  },
...
bingoList[14] = [
  {
    name: "Radical Highway All Missions A-Rank",
    types: ["radicalhighway", "arank", "allmissions"],
  },
  {
    name: "Pumpkin Hill All Missions A-Rank",
    types: ["pumpkinhill", "arank", "allmissions"],
  },
  {
    name: "Egg Quarters All Missions A-Rank",
    types: ["eggquarters", "arank", "allmissions"],
  },
  ...
  {
    name: "Complete Mission Street M1 with 100+ Rings",
    types: ["missionstreet"],
  },
  {
    name: "2 Chao Boxes in Mission Street and finish",
    types: ["missionstreet"],
  },
  {
    name: "5 hidden animals in Mission Street and finish",
    types: ["missionstreet"],
  },
  {
    name: "Destroy the Gold Beetle in 6 Hero Story stages",
    types: ["goldbeetle"],
  },
  ...
  {
    name: "5 hidden animals in Aquatic Mine and finish",
    types: ["aquaticmine"],
  },
  ...
  {
    name: "Complete Security Hall M1 with 100+ Rings",
    types: ["securityhall"],
  },
  { name: "2 Chao Boxes in Security Hall and finish", types: ["securityhall"] },
  {
    name: "5 hidden animals in Security Hall and finish",
    types: ["securityhall"],
  },
  {
    name: "Destroy the Gold Beetle in 6 Dark Story stages",
    types: ["goldbeetle"],
  },
  {
    name: "Complete Security Hall M1 with a Magnetic Shield",
    types: ["securityhall"],
  },
];
bingoList[15] = [
...
bingoList[16] = [
  {
    name: "Green Forest All Missions A-Rank",
    types: ["greenforest", "arank", "allmissions"],
  },
  ...
  {
    name: "5 hidden animals in White Jungle and finish",
    types: ["whitejungle"],
  },
...
bingoList[17] = [
  {
    name: "Security Hall All Missions A-Rank",
    types: ["securityhall", "arank", "allmissions"],
  },
  {
    name: "Aquatic Mine All Missions A-Rank",
    types: ["aquaticmine", "arank", "allmissions"],
  },
  ...
  {
    name: "Game Over during Pyramid Cave M1",
    types: ["pyramidcave", "gameover"],
  },
  ...
  {
    name: "5 hidden animals in Pyramid Cave and finish",
    types: ["pyramidcave"],
  },
...
bingoList[18] = [
  ...
  {
    name: "Complete Death Chamber M1 with 100+ Rings",
    types: ["deathchamber"],
  },
  { name: "2 Chao Boxes in Death Chamber and finish", types: ["deathchamber"] },
  {
    name: "5 hidden animals in Death Chamber and finish",
    types: ["deathchamber"],
  },
...
bingoList[19] = [
  {
    name: "Lost Colony All Missions A-Rank",
    types: ["lostcolony", "arank", "allmissions"],
  },
...
bingoList[21] = [
  ...
  {
    name: "Complete Eternal Engine M1 with 100+ Rings",
    types: ["eternalengine"],
  },
  {
    name: "2 Chao Boxes in Eternal Engine and finish",
    types: ["eternalengine"],
  },
  {
    name: "5 hidden animals in Eternal Engine and finish",
    types: ["eternalengine"],
  },
  { name: "Meteor Herd M1 Hintless", types: ["meteorherd"] },
  {
    name: "Complete Eternal Engine M1 with a Magnetic Shield",
    types: ["eternalengine"],
  },
  { name: "Knuckles' Sunglasses", types: ["meteorherd"] },
  { name: "Prison Lane M5", types: ["prisonlane"] },
  {
    name: "Complete Eternal Engine via all 5 Checkpoints",
    types: ["eternalengine"],
  },
];
bingoList[22] = [
  ...
  {
    name: "Destroy the Gold Beetle in 10 different stages",
    types: ["goldbeetle", "multistory"],
  },
  ...
  {
    name: "Prison Lane All Missions A-Rank",
    types: ["prisonlane", "arank", "allmissions"],
  },
  {
    name: "Death Chamber All Missions A-Rank",
    types: ["deathchamber", "arank", "allmissions"],
  },
];
bingoList[23] = [
  ...
  {
    name: "5 hidden animals in Crazy Gadget and finish",
    types: ["crazygadget"],
  },
  {
    name: "Complete Crazy Gadget M1 with a Magnetic Shield",
    types: ["crazygadget"],
  },
  {
    name: "Complete Crazy Gadget via all 5 Checkpoints",
    types: ["crazygadget"],
  },
...
bingoList[24] = [
  ...
  {
    name: "Complete Final Rush M1 with a Magnetic Shield",
    types: ["finalrush"],
  },
...
bingoList[25] = [{ name: "80 Emblems (Team Combined)", types: ["emblems"] }];
