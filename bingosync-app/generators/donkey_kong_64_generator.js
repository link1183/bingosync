...
bingoList[5] = [
  ...
  {
    name: "All 100 Bananas with any Kong in any level",
    types: [
      "japesbananas",
      "aztecbananas",
      "factorybananas",
...
bingoList[6] = [
  ...
  { name: "Giant Toy Monster GB", types: ["chunky", "factory"] },
  {
    ...
    types: ["factory", "manybp", "bp", "factorybp"],
  },
  {
...
bingoList[8] = [
  ...
  {
    name: "All 3 Batty Barrel Bandit GBs",
    types: ["factory", "gloomy", "bonus"],
  },
];
bingoList[9] = [
  {
    name: "Both Tree GBs in Creepy Castle",
    types: ["chunky", "donkey", "castle"],
  },
  {
    name: "All Blueprints in Gloomy Galleon",
    types: ["gloomy", "manybp", "bp", "galleonbp"],
  },
  {
    name: "Activate All Warps in Creepy Castle",
    types: ["castle", "castlewarp"],
  },
  ...
  {
    name: "100 bananas for any Kong in Jungle Japes",
    types: ["japesbananas", "japes"],
  },
...
bingoList[10] = [
  { name: "Both Banana Fairies in Crystal Caves", types: ["cave", "fairy"] },
  {
    ...
    types: ["manybp", "castle", "bp", "castlebp"],
  },
  {
    name: "All Blueprints in Crystal Caves",
    types: ["manybp", "cave", "bp", "cavebp"],
  },
  ...
  { name: "Beanstalk GB", types: ["tiny", "fungi"] },
  {
    ...
    types: ["castlecrown", "castle", "lanky"],
  },
...
bingoList[11] = [
  ...
  },
  {
    ...
    types: ["japesbananas", "japes", "medal"],
  },
  {
    name: "10 Donkey GBs",
    types: [
  ...
  {
    name: "1 GB for each Kong in Gloomy Galleon",
    types: ["gloomy", "gloomygb"],
  },
  {
    name: "200 Bananas in Frantic Factory",
    types: ["factorybananas", "factory"],
  },
  {
    name: "100 Bananas for any Kong in Angry Aztec",
    types: ["aztec", "aztecbananas"],
  },
...
bingoList[13] = [
  ...
  {
    name: "100 Bananas for any Kong in Frantic Factory",
    types: ["factory", "factorybananas"],
  },
  {
    name: "100 Bananas for any Kong in Gloomy Galleon",
    types: ["gloomy", "gloomybananas"],
  },
];
bingoList[14] = [
...
bingoList[15] = [
  {
    ...
    types: ["factory", "medal", "factorybananas"],
  },
  {
    name: "100 bananas for any Kong in Fungi Forest",
    types: ["fungi", "fungibananas"],
  },
  { name: "All 5 GBs in 5 Door Igloo", types: ["cavegb", "cave"] },
  {
    name: "100 bananas for any Kong in Crystal Caves",
    types: ["cave", "cavebananas"],
  },
...
bingoList[16] = [
  ...
  {
    name: "100 bananas for any Kong in Creepy Castle",
    types: ["castle", "castlebananas"],
  },
...
bingoList[17] = [
  ...
  { name: "All 5 Production Room GBs", types: ["factory", "factorygb"] },
  {
    ...
    types: ["gloomy", "medal", "gloomybananas"],
  },
  {
    name: "All Blueprints in Fungi Forest",
    types: ["fungi", "bp", "manybp", "fungibp"],
  },
  {
  ...
  {
    name: "1 GB for each Kong in Creepy Castle",
    types: ["castlegb", "castle"],
  },
  {
...
bingoList[18] = [
  ...
  {
    name: "All 4 Bonus Barrel GBs in Giant Mushroom area",
    types: ["fungi, fungigb"],
  },
  ...
  {
    name: "2 GBs for each Kong in Jungle Japes",
    types: ["japesgb", "manybp", "japes"],
  },
];
bingoList[19] = [
  {
  ...
  {
    name: "2 GBs for each Kong in Frantic Factory",
    types: ["factory", "manybp", "factorygb"],
  },
  {
    name: "3 Blueprints on each Kong",
    types: [
      "manybp",
      "japesbp",
      "aztecbp",
...
bingoList[21] = [
  ...
  {
    name: "Activate All Purple Warps",
    types: [
      "manylevel",
      "japeswarp",
      "aztecwarp",
  ...
  {
    name: "2 GBs for each Kong in Gloomy Galleon",
    types: ["gloomy", "manybp", "galleongb"],
  },
];
bingoList[22] = [
  {
    name: "Chunky's Banana Medal in Hideout Helm",
    types: ["helm", "medal", "chunky"],
  },
  { name: "10 GBs in Crystal Caves", types: ["cavegb", "cave"] },
  {
    name: "3 Banana Medals in Fungi Forest",
    types: ["fungibananas", "medal", "fungi"],
  },
  {
  ...
  },
  {
    ...
    types: ["castlebananas", "castle", "medal"],
  },
  {
    name: "15 Donkey GBs",
    types: [
  ...
  {
    name: "2 GBs for each Kong in DK Isles",
    types: ["isles", "manybp", "islesgb"],
  },
  {
    name: "Activate All Red Warps",
    types: [
      "manylevel",
      "japeswarp",
      "aztecwarp",
  ...
  {
    name: "Activate All Yellow Warps",
    types: [
      "manylevel",
      "japeswarp",
      "aztecwarp",
...
bingoList[23] = [
  ...
  {
    name: "2 GBs for each Kong in Crystal Caves",
    types: ["cavegb", "cave", "manybp"],
  },
  {
    name: "Activate All Blue Warps",
    types: [
      "manylevel",
      "japeswarp",
      "aztecwarp",
...
bingoList[24] = [
  ...
  {
    name: "Complete All 7 Baboon Blasts",
    types: [
      "donkey",
      "manylevel",
      "japesgb",
  ...
  {
    name: "4 Blueprints on each Kong",
    types: [
      "bp",
      "manybp",
      "japesbp",
  ...
  {
    name: "2 GBs for each Kong in Angry Aztec",
    types: ["aztec", "manybp", "aztecgb"],
  },
  {
    name: "8 Bonus Barrel GBs",
    types: [
      "bonus",
      "japesgb",
      "aztecgb",
...
bingoList[25] = [
  ...
  {
    name: "Complete Diddy's phase of K. Rool Fight",
    types: ["key3", "key8", "key", "manykey"],
  },
  ...
  {
    name: "2 GBs for Each Kong in Creepy Castle",
    types: ["castle", "castlegb"],
  },
  {
    name: "15 Diddy GBs",
    types: [
  ...
  {
    name: "All banana medals for any level",
    types: [
      "medal",
      "japesbananas",
      "aztecbananas",
