...
bingoList[4] = [
  ...
  { name: "Save 3 Men from the Mafia's Beating", types: ["mafia"] },
];
bingoList[5] = [
...
bingoList[10] = [
  ...
  { name: "Craft the Dweller Mask", types: ["hat"] },
  { name: "Collect the Relic on Top of Snatcher’s Home", types: ["relic"] },
];
bingoList[11] = [
...
bingoList[12] = [
  ...
  { name: "Selfie at the top of floating stonehenge", types: ["subcon"] },
  { name: "Complete the Murder on the Owl Express", types: ["botb"] },
];
bingoList[13] = [
...
bingoList[16] = [
  ...
  { name: "Collect 5 Roulette Tokens", types: ["token"] },
];
bingoList[17] = [
  { name: "Complete 3 Painting Burning Rituals in Subcon", types: ["subcon"] },
  { name: "Create a Relic in the Gallery", types: [""] },
  { name: "Parade Selfie", types: ["botb"] },
];
bingoList[18] = [
  { name: "Owl Express Rift", types: ["botb"] },
  { name: "Train rush with 100+ seconds left", types: ["botb"] },
];
bingoList[19] = [
  { name: "Destroy 3 tracker eyeballs in Subcon forest", types: ["subcon"] },
  { name: "Collect 10 Relics", types: ["relic"] },
];
bingoList[20] = [
  { name: "Cheat the Race", types: ["mafia"] },
  { name: "Craft 4 hats", types: ["hat"] },
];
bingoList[21] = [
  { name: "Repair 3 Relics", types: ["relic"] },
  { name: "Collect 13 Relics", types: ["relic"] },
];
bingoList[22] = [
  { name: "Get all 10 Time Pieces from Mafia Town", types: ["mafia"] },
  { name: "Collect 7 Roulette Tokens", types: ["token"] },
];
bingoList[23] = [
