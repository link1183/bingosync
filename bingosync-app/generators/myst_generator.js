...
bingoList[3] = [
  ...
  {
    name: "View Channelwood future bridge diagram",
    types: ["mystisland", "library"],
  },
];
bingoList[4] = [
  {
    name: "Deliberately trip the breaker in the powerhouse",
    types: ["mystisland", "gate"],
  },
...
bingoList[7] = [
  {
    name: "Tower Rotation hint (Mechanical)",
    types: ["mystisland", "rotation"],
  },
  {
    name: "Tower Rotation hint (Stoneship)",
    types: ["mystisland", "rotation"],
  },
...
bingoList[8] = [
  {
    name: "Tower Rotation hint (Channelwood)",
    types: ["mystisland", "rotation"],
  },
  {
    name: "Tower Rotation hint (Selenetic)",
    types: ["mystisland", "rotation"],
  },
...
bingoList[11] = [
  ...
  {
    name: "View decapitated head in Mechanical",
    types: ["mechanical", "click"],
  },
...
bingoList[16] = [
  ...
  {
    name: "View the lighthouse through the telescope",
    types: ["stoneship", "cutscene"],
  },
  {
    name: "View first half of Marker Switch hint page",
    types: ["stoneship", "click"],
  },
];
bingoList[17] = [
  ...
  {
    name: "View skull hologram in Achenar's room",
    types: ["stoneship", "cutscene"],
  },
];
bingoList[18] = [
...
bingoList[19] = [
  {
    name: "View padlock at bottom of lighthouse",
    types: ["stoneship", "click"],
  },
  {
    name: "Fully charge the generator in Stoneship",
    types: ["stoneship", "cutscene"],
  },
...
bingoList[20] = [
  ...
  {
    name: "Watch Atrus's message to Catherine",
    types: ["mystisland", "cutscene"],
  },
  { name: "Collect Selenetic blue page", types: ["selenetic", "bpage"] },
  { name: "Collect Selenetic red page", types: ["selenetic", "rpage"] },
];
bingoList[21] = [
  ...
  {
    name: "View second half of Mechanical code",
    types: ["mechanical", "rotation"],
  },
  {
    name: "Trigger useless lever in windmill room",
    types: ["channelwood", "click"],
  },
];
bingoList[22] = [
  { name: "View Bob through telescope", types: ["mechanical", "rotation"] },
  {
    name: "View first half of Mechanical code",
    types: ["mechanical", "rotation"],
  },
...
bingoList[23] = [
  ...
  {
    name: "View second half of Marker Switch hint page",
    types: ["channelwood", "click"],
  },
  { name: "View Sirrus's dagger", types: ["channelwood", "click"] },
  {
    name: "Solve the audio cue puzzle in Selenetic",
    types: ["selenetic", "cutscene"],
  },
];
bingoList[24] = [
  {
    name: "View Achenar's third recording",
    types: ["channelwood", "cutscene"],
  },
  {
    name: "View Achenar's first recording",
    types: ["channelwood", "cutscene"],
  },
  {
    name: "View Achenar's second recording",
    types: ["channelwood", "cutscene"],
  },
];
bingoList[25] = [
