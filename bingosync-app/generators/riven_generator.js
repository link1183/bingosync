...
bingoList[1] = [
  ...
  {
    name: "Read about Star Fissure in Atrus's journal",
    types: ["Riven", "code"],
  },
];
bingoList[2] = [
...
bingoList[3] = [
  ...
  {
    name: "Look at the tram platform through the viewer",
    types: ["temple", "click"],
  },
...
bingoList[4] = [
  ...
  {
    name: "Sit in Gehn's imager chair with sound on",
    types: ["temple", "cutscene"],
  },
  {
    name: "Ride tram from Jungle Island to Temple Island",
    types: ["jungle", "click"],
  },
  {
    name: "Raise gate from gate room to golden dome",
    types: ["temple", "gate"],
  },
...
bingoList[6] = [
  {
    name: "Divert steam to boiler island/golden dome bridge",
    types: ["temple", "gate"],
  },
...
bingoList[7] = [
  ...
  {
    name: "Ride tram from Jungle Island to Survey Island",
    types: ["jungle", "click"],
  },
  { name: "Open fire marble dome (Jungle)", types: ["jungle", "code"] },
  {
    name: "Ride tram from Survey Island to Jungle Island",
    types: ["survey", "click"],
  },
];
bingoList[8] = [
  ...
  {
    name: "View Gehn's projection in the Temple",
    types: ["temple", "cutscene"],
  },
...
bingoList[9] = [
  ...
  {
    name: "Unlock hatch above ladder on Crater Island",
    types: ["crater", "click"],
  },
...
bingoList[10] = [
  ...
  {
    name: "Ride tram from Survey Island to Crater Island",
    types: ["survey", "click"],
  },
...
bingoList[12] = [
  ...
  {
    name: "Look at the wahrk gallows through viewer",
    types: ["survey", "click"],
  },
...
bingoList[13] = [
  ...
  {
    name: "Ride tram from Crater Island to Survey Island",
    types: ["crater", "click"],
  },
...
bingoList[16] = [
  ...
  {
    name: "Watch the elevator rise out of the water",
    types: ["survey", "cutscene"],
  },
];
bingoList[17] = [
  { name: "Frighten away Gehn's assistent", types: ["survey", "cutscene"] },
  {
    name: "Lower bridge from crater island to golden dome",
    types: ["crater", "click"],
  },
  { name: "Extend golden dome gangway", types: ["temple", "gate"] },
  { name: "Raise side gate room outer gate", types: ["temple", "gate"] },
  {
    name: "Look in on the prisoner at the gallows",
    types: ["jungle", "cutscene"],
  },
...
bingoList[21] = [
  ...
  {
    name: "Look at the Starry Expanse through the telescope",
    types: ["temple", "click"],
  },
];
bingoList[22] = [
  ...
  {
    name: "Summon the golden elevator with blue button",
    types: ["survey", "click"],
  },
...
bingoList[25] = [
  ...
  {
    name: "Summon Temple Island tram and have it not show up",
    types: ["temple", "click"],
  },
