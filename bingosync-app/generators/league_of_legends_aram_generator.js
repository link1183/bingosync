...
bingoList[1] = [
  ...
  {
    name: "Get a triplekill with one spellcast.",
    types: ["MultikillOneSpell"],
  },
...
bingoList[2] = [
  ...
  {
    name: "Have the same amount of kills, deaths and assists.",
    types: ["KDA"],
  },
  {
    name: "Play a game with only melee champs in your team.",
    types: ["Teamcomp"],
  },
...
bingoList[4] = [
  ...
  {
    name: "Flash to block an ability that would hit an ally under 100/200/300 HP up to Lvl 5/10/15.",
    types: [],
  },
];
bingoList[5] = [
  ...
  {
    name: "Get a doublekill with one spellcast.",
    types: ["MultikillOneSpell"],
  },
];
bingoList[6] = [
...
bingoList[7] = [
  ...
  {
    name: "Win a game with at least 3 yordles on your team.",
    types: ["Teamcomp"],
  },
  {
    name: "Have 5 champs of a specific region in your team.",
    types: ["Teamcomp"],
  },
...
bingoList[8] = [
  ...
  {
    name: "Build 3 complete items that build out of Sheen.",
    types: ["StackItems"],
  },
];
bingoList[9] = [
...
bingoList[14] = [
  ...
  {
    name: "Finish the Game with only identical finished items.",
    types: ["StackItems"],
  },
...
bingoList[17] = [
  ...
  {
    name: "Finish with 6 tears at the end of the game.",
    types: ["StackItems"],
  },
...
bingoList[19] = [
  ...
  {
    name: "But my body is telling me yeeees (always follow snowball).",
    types: ["Snowball"],
  },
...
bingoList[20] = [
  ...
  {
    name: "My mind is telling me no (never follow snowball).",
    types: ["Snowball"],
  },
...
bingoList[23] = [
  ...
  {
    name: "Buy Twin Shadows and roleplay while activating (BOOOO).",
    types: [],
  },
];
bingoList[24] = [
