...
bingoList[9] = [
  ...
  {
    name: "Hit the last Electrode in Tunnel without activating the cutscene",
    types: ["tunnel"],
  },
...
bingoList[11] = [
  ...
  {
    name: "Add pics of all three Pikachus in Tunnel to the album",
    types: ["tunnel", "album"],
  },
];
bingoList[12] = [
...
bingoList[13] = [
  ...
  {
    name: "Pic: Centered pic of the Porygon activating the switch",
    types: ["river"],
  },
  {
    name: "Make all four Bulbasaurs in Cave evolve",
    types: ["pester", "bulbasaur"],
  },
...
bingoList[15] = [
  ...
  {
    name: "Make Sandslash faint with a pester ball",
    types: ["valley", "pester"],
  },
...
bingoList[18] = [
  {
    name: "Add pics of three different Snorlax dances to the album",
    types: ["flute", "beach", "album"],
  },
  {
    name: "Add pics of four different Mankeys to the album",
    types: ["valley", "album"],
  },
...
bingoList[19] = [
  ...
  {
    name: "Add pics of three different Vileplume dances to the album",
    types: ["river", "flute", "album"],
  },
...
bingoList[20] = [
  ...
  {
    name: "Add pics of five different exploded Electrodes to the album",
    types: ["apple", "tunnel", "album"],
  },
  {
    name: "Add pics of all three legendary bird eggs to the album",
    types: ["album"],
  },
  {
    name: "Add pic of two combined Magnemites to the album",
    types: ["tunnel"],
  },
...
bingoList[21] = [
  {
    name: "Add pic of a jumping Vileplume to the album",
    types: ["river", "flute", "album"],
  },
...
bingoList[23] = [
  ...
  {
    name: "Add pics of two different Charmeleons on the floor to the album",
    types: ["volcano", "pester"],
  },
...
bingoList[25] = [
  ...
  {
    name: "Submit 11 Centered pics of different Pokemon in Valley",
    types: ["valley"],
  },
  { name: "Pic: Pikachu riding Articuno", types: ["cave"] },
  {
    name: "Add two Pokemon signs and their corresponding Pokemon to the album",
    types: ["volcano"],
  },
  {
    name: "Throw 200 apples into the river in Valley",
    types: ["valley", "apple"],
  },
