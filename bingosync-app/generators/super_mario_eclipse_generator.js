...
var bingoList = [
  ...
  [
    {
      ...
      types: ["level_blues", "total_blues"],
    },
    { name: "6 Hidden Shines", types: ["hidden"] },
    { name: "2 Shine Button Shines", types: ["task"] },
    {
      name: " 20 Total Blues From Cruiser Hub Worlds",
      types: ["level_blues", "total_blues"],
    },
  ...
  [
    ...
    {
      name: " 3 Shines From 2 Cruiser Hub Worlds",
      types: ["x_shines_in_x_levels"],
    },
  ...
  [
    ...
    {
      name: " 2 Shines From 2 Cruiser Hub Worlds",
      types: ["x_shines_in_x_levels"],
    },
    {
      name: " 2 Shines From 3 Cruiser Hub Worlds",
      types: ["x_shines_in_x_levels"],
    },
  ],
  [
  ...
  [
    ...
    {
      name: "1 Shine from each new pre-cruiser Level",
      types: ["x_shines_in_x_levels"],
    },
  ],
  [
    ...
    {
      name: "1 Shine from each vanilla Level",
      types: ["x_shines_in_x_levels"],
    },
  ...
  [
    ...
    {
      name: "14 Delfino Shines (With Blue Trades + transitions)",
      types: ["delfino_shines"],
    },
    {
      name: "16 Delfino Shines (With Blue Trades + transitions)",
      types: ["delfino_shines"],
    },
  ...
  [
    ...
    {
      name: "3 Shines from 2 Cruiser Hub Levels",
      types: ["x_shines_in_x_levels"],
    },
    {
      name: "3 Shines from 3 Cruiser Hub Levels",
      types: ["x_shines_in_x_levels"],
    },
    {
      name: "1 Shine from 4 Cruiser Hub Levels",
      types: ["x_shines_in_x_levels"],
    },
    {
      name: "2 Shines from 4 Cruiser Hub Levels",
      types: ["x_shines_in_x_levels"],
    },
  ...
  [
    ...
    {
      name: "Complete All Episodes of 1 Cabin Level",
      types: ["cabin", "episode_shines"],
    },
  ],
  [
    {
      name: "10 Blue Coins from 4 Unique Worlds",
      types: ["total_blues", "level_blues"],
    },
    ...
    {
      name: "20 Total Blue Coins from Cruiser Hub Worlds",
      types: ["total_blues", "level_blues"],
    },
  ],
  [
    {
      name: "12 Blue Coins from 4 Unique Levels",
      types: ["total_blues", "level_blues"],
    },
    {
      name: "8 Blue Coins from 3 Unique Cruiser Hub Worlds",
      types: ["total_blues", "level_blues"],
    },
    {
      name: "30 Total Blue Coins from Cruiser Hub Worlds",
      types: ["total_blues", "level_blues"],
    },
