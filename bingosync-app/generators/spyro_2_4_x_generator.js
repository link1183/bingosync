...
bingoList[1] = [
  ...
  {
    name: "Outdoor Lamps & Tractor Path",
    types: ["outdoorlamps", "tractorpath", "glirob"],
  },
  {
    name: "Outdoor Lamps & Party Crashers",
    types: ["outdoorlamps", "partycrashers", "glimag"],
  },
...
bingoList[2] = [
  ...
  {
    name: "Lightning Orbs & Lamp Thieves",
    types: ["lightningorbs", "lampthieves", "hursha"],
  },
  {
    name: "Lightning Orbs & Floating Mines",
    types: ["lightningorbs", "floatingmines", "hurbre"],
  },
...
bingoList[3] = [
  ...
  {
    name: "Factory Glide 2 & Trolley",
    types: ["factoryglide2", "trolley", "hurbre"],
  },
  {
    name: "Trolley & Lamp Thieves",
    types: ["trolley", "lampthieves", "bresha"],
  },
...
bingoList[9] = [
  ...
  {
    name: "Lizard Hunt & #BoneDance",
    types: ["lizardhunt", "bonedance", "gliske"],
  },
  ...
  {
    name: "Lizard Hunt & Hockey 2",
    types: ["lizardhunt", "hockey2", "glicol"],
  },
];
bingoList[10] = [
...
bingoList[11] = [
  ...
  {
    name: "Hula Girls & Turtle Boxes",
    types: ["hulagirls", "turtleboxes", "idosun"],
  },
...
bingoList[12] = [
  ...
  {
    name: "Turtle Soup 1 & Mantas 2",
    types: ["turtlesoup1", "mantas2", "sunaqu"],
  },
  {
    name: "Puzzle & Turtle Soup 1",
    types: ["puzzle", "turtlesoup1", "idosun"],
  },
...
bingoList[13] = [
  ...
  {
    name: "Indoor Lamps & Robot Scarecrows",
    types: ["indoorlamps", "robotscarecrows", "glirob"],
  },
  {
    name: "Party Crashers & Robot Scarecrows",
    types: ["partycrashers", "robotscarecrows", "magrob"],
  },
...
bingoList[14] = [
  ...
  {
    name: "Turtle Boxes & Seahorses",
    types: ["turtleboxes", "seahorses", "sunaqu"],
  },
...
bingoList[15] = [
  ...
  {
    name: "Spirit Statues & Dinos 1",
    types: ["spiritstatues", "dinos1", "colske"],
  },
...
bingoList[16] = [
  ...
  {
    name: "Spirit Statues & Pencil",
    types: ["spiritstatues", "pencil", "colmys"],
  },
...
bingoList[21] = [
  {
    name: "Turtle Soup 2 & Alchemist",
    types: ["turtlesoup2", "alchemist", "sunfra"],
  },
  { name: "Mantas 1 & Popcorn 2", types: ["mantas1", "popcorn2", "aqumag"] },
  {
    name: "Factory Glide 1 & Cowleks 2",
    types: ["factoryglide1", "cowleks2", "hurzep"],
  },
  ...
  { name: "2000 gems", types: [] },
  {
    name: "Hockey 2 & Factory Glide 1",
    types: ["hockey2", "factoryglide1", "colhur"],
  },
];
bingoList[22] = [
  ...
  {
    name: "Floating Mines & Hippos",
    types: ["floatingmines", "hippos", "bresha"],
  },
  {
    name: "Factory Glide 2 & Hippos",
    types: ["factoryglide2", "hippos", "hursha"],
  },
...
bingoList[23] = [
  ...
  {
    name: "Juliet 2 &  Earthshapers",
    types: ["juliet2", "earthshapers", "zepfra"],
  },
  { name: "Use all '14' powerups", types: ["14p"] },
...
bingoList[25] = [
  ...
  {
    name: "Indoor Lamps & Popcorn 1",
    types: ["indoorlamps", "popcorn1", "glimag"],
  },
  {
    name: "Popcorn 1 & Tractor Path",
    types: ["popcorn1", "tractorpath", "robmag"],
  },
  { name: "Use all '15' powerups", types: ["15p"] },
  {
    name: "600 combined gems in Crystal Glacier and Robotica Farms",
    types: [],
  },
