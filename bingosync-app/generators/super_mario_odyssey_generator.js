...
bingoList[1] = [
  {
    name: "Good Morning, Captain Toad! (Cascade)",
    types: ["Cascade", "Captain_Toad"],
  },
...
bingoList[2] = [
  ...
  {
    name: "How You Doin', Captain Toad? (Metro)",
    types: ["Metro", "Captain_Toad"],
  },
...
bingoList[5] = [
  ...
  {
    name: "Let's Go Swimming, Captain Toad! (Lake)",
    types: ["Lake", "Captain_Toad"],
  },
...
bingoList[10] = [
  ...
  {
    name: "Showdown on the Inverted Pyramid (Sand)",
    types: ["Sand_Story", "Story"],
  },
...
bingoList[16] = [
  ...
  {
    name: "World Peace in 3 Kingdoms (excl. Cap, Cloud, Lost)",
    types: ["World_Peace"],
  },
  { name: "30 Regional Coins (Lost)", types: ["Lost_Regional"] },
  { name: "10 Regional Coins (Snow)", types: ["Late_Game", "Snow_Regional"] },
  {
    name: "Captain Toad is Chilly! (Snow)",
    types: ["Late_Game", "Snow", "Captain_Toad"],
  },
...
bingoList[17] = [
  ...
  {
    name: "Uncork 1 Fountain (Seaside)",
    types: ["Late_Game", "Uncork", "Story"],
  },
  {
    name: "Good Job, Captain Toad! (Seaside)",
    types: ["Late_Game", "Seaside", "Captain_Toad"],
  },
...
bingoList[18] = [
  ...
  {
    name: "Uncork 2 Fountains (Seaside)",
    types: ["Late_Game", "Uncork", "Story"],
  },
  ...
  {
    name: "Moon Shards in the Cold Room (Snow)",
    types: ["Late_Game", "Locked_Door"],
  },
];
bingoList[19] = [
  ...
  {
    name: "Uncork 3 Fountains (Seaside)",
    types: ["Late_Game", "Uncork", "Story"],
  },
  {
    name: "25 Regional Coins (Seaside)",
    types: ["Late_Game", "Seaside_Regional"],
  },
...
bingoList[20] = [
  ...
  {
    name: "30 Regional Coins (Seaside)",
    types: ["Late_Game", "Seaside_Regional"],
  },
...
bingoList[21] = [
  ...
  {
    name: "35 Regional Coins (Seaside)",
    types: ["Late_Game", "Seaside_Regional"],
  },
...
bingoList[22] = [
  ...
  {
    name: "2 Moons from sub-areas (Seaside)",
    types: ["Late_Game", "Seaside", "Sub_Areas"],
  },
  {
    name: "40 Regional Coins (Seaside)",
    types: ["Late_Game", "Seaside_Regional"],
  },
  { name: "100 Moons (Total)", types: ["Total_Moons"] },
  {
    name: "3 Ground-Pound Moons (Seaside)",
    types: ["Late_Game", "Seaside", "Seaside_Moons"],
  },
  { name: "18 Moons (Lake)", types: ["Lake_Moons"] },
  {
    name: "Answer 8 Sphynx Questions Correctly",
    types: ["Late_Game", "Sphynx"],
  },
...
bingoList[23] = [
  ...
  {
    name: "4 Ground-Pound Moons (Seaside)",
    types: ["Late_Game", "Seaside", "Seaside_Moons"],
  },
...
bingoList[24] = [
  ...
  {
    name: "5 Ground-Pound Moons (Seaside)",
    types: ["Late_Game", "Seaside", "Seaside_Moons"],
  },
  {
    name: "4 Moons from sub-areas (Seaside)",
    types: ["Late_Game", "Seaside", "Sub_Areas"],
  },
];
bingoList[25] = [
  ...
  {
    name: "6 Ground-Pound Moons (Seaside)",
    types: ["Late_Game", "Seaside", "Seaside_Moons"],
  },
];
