...
urlpatterns = [
    ...
    re_path(
        r"^room/(?P<encoded_room_uuid>.+)/board$", views.room_board, name="room_board"
    ),
    re_path(
        r"^room/(?P<encoded_room_uuid>.+)/feed$", views.room_feed, name="room_feed"
    ),
    re_path(
        r"^room/(?P<encoded_room_uuid>.+)/disconnect$",
        views.room_disconnect,
        name="room_disconnect",
    ),
    re_path(
        r"^room/(?P<encoded_room_uuid>.+)/room-settings$",
        views.room_settings,
        name="room_settings",
    ),
    ...
    re_path(
        r"^api/get-socket-key/(?P<encoded_room_uuid>.+)$",
        views.get_socket_key,
        name="get_socket_key",
    ),
    re_path(
        r"^api/connected/(?P<encoded_player_uuid>.+)$",
        views.user_connected,
        name="user_connected",
    ),
    re_path(
        r"^api/disconnected/(?P<encoded_player_uuid>.+)$",
        views.user_disconnected,
        name="user_disconnected",
    ),
    re_path(
        r"^api/socket/(?P<socket_key>.+)$",
        views.check_socket_key,
        name="check_socket_key",
    ),
