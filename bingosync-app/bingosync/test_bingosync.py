...
class HomeTestCase(test.TestCase):
    ...
    def test_home_create_room_timeout(self):
        inject_eval_generator_exception(
            TEST_GAME_TYPE.generator_instance(), "some error message"
        )
...
class CustomTestCase(test.TestCase):
    ...
    def test_basic_custom(self):
        ...
        create_resp = self.make_room_with_custom_json(
            custom_json=json.dumps(custom_goals)
        )
    ...
    def test_random_custom(self):
        ...
        self.assertEqual(
            set(tuple(goal.items()) for goal in board_goals),
    ...
    def test_srl_v5_custom(self):
        self.maxDiff = 100000
        create_resp = self.make_room_with_custom_json(
            custom_json=json.dumps(self.numeric_srl_goals),
    ...
    def test_isaac_custom(self):
        self.maxDiff = 100000
        create_resp = self.make_room_with_custom_json(
            custom_json=json.dumps(self.numeric_isaac_goals),
    ...
    def test_invalid_missing_name(self):
        ...
        self.assertContains(
            create_resp,
            "Square 3 ({&quot;naem&quot;: &quot;foo&quot;}) is missing a &quot;name",
        )
    ...
    def test_invalid_empty_name(self):
        ...
        self.assertContains(
            create_resp,
            "Square 3 ({&quot;name&quot;: &quot;&quot;}) has an empty &quot;name",
        )
    ...
    def test_invalid_srl_num_tiers(self):
        ...
        self.assertContains(
            create_resp, "An SRL goal list must have exactly 25 tiers (found 24)"
        )
    ...
    def test_invalid_srl_non_list_tier(self):
        ...
        self.assertContains(
            create_resp,
            "Element at difficulty tier 3 was not a list (found {&quot;foo&quot;: &quot;bar&quot;})",
        )
    ...
    def test_invalid_srl_missing_name(self):
        ...
        self.assertContains(
            create_resp,
            "Goal 1 ({&quot;naem&quot;: &quot;foo&quot;}) in difficulty tier 3 is missing a &quot;name&quot; attribute",
        )
    ...
    def test_invalid_srl_empty_name(self):
        ...
        self.assertContains(
            create_resp,
            "Goal 1 ({&quot;name&quot;: &quot;&quot;}) in difficulty tier 3 has an empty &quot;name&quot; attribute",
        )
...
class ApiTestCase(test.TestCase):
    ...
    def test_join_room_api(self):
        ...
        join_room_resp = self.client.post(
            "/api/join-room",
            json.dumps(
                {
    ...
    def test_join_room_api_missing_password(self):
        ...
        self.assertContains(
            join_room_resp, "missing required key: 'password'", status_code=400
        )
    ...
    def test_join_room_api_empty_password(self):
        ...
        self.assertContains(
            join_room_resp, "empty string for required key: 'password'", status_code=400
        )
