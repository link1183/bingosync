...
try:
    from bingosync.secret_settings import (
        IS_PROD,
        SECRET_KEY,
        ADMINS,
        SERVER_EMAIL,
    ...
    raise ImportError(
        "secret_settings.py is missing! "
        "You may need to create one from secret_settings.py.template"
    ) from e
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "bingosync"),
